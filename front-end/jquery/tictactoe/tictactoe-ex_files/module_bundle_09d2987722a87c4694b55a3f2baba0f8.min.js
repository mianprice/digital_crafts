...
b+='    <div class="title">%title</div>';b+='    <div class="clear-block"></div>';b+="  </div>";b+='  <div class="popups-body" tabindex="0">%body</div>';b+='  <div class="popups-buttons tabindex="0">%buttons</div>';b+='  <div class="popups-footer"></div>';b+="</div>";return b};Drupal.behaviors.sCommonMediaFileIframeUseRelativeUrl=function(a){var b=/^\/?media\/ifr\/\d+$/;var c=/^\/?media\/ifr_ext$/;$("#main iframe:not(.sCommonMediaFileIframeUseRelativeUrl-processed), .s-page-container iframe:not(.sCommonMediaFileIframeUseRelativeUrl-processed),.template-fields iframe:not(.sCommonMediaFileIframeUseRelativeUrl-processed)",a).addClass("sCommonMediaFileIframeUseRelativeUrl-processed").each(function(){var f=$(this);var h=f.attr("src");var g=document.createElement("a");g.href=h;var e=g.pathname;var d=b.exec(e);if(!d){d=c.exec(e)}if(d){if(e[0]!=="/"){e="/"+e}if(g.search){e+=g.search}f.attr("src",e)}})};Drupal.behaviors.sPageNav=function(a){$(".s-page-nav-wrapper .slide-toggler:not(.sPage-processed)",a).addClass("sPage-processed").each(function(){var b=$("a",$(this));
b.bind("click",function(){var c=$(this).parent().parent().parent();if(c.width()=="20"){c.animate({width:"250px"},400,"easeInOutQuint",function(){c.addClass("open")})}else{c.animate({width:"20px"},400,"easeInOutQuint",function(){c.removeClass("open")})}return false})});$(".page-menu .action-links-wrapper:not(.sPage-processed)",a).addClass("sPage-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})});$(".s-page-nav .action-links-wrapper:not(.sPage-processed)",a).addClass("sPage-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})})};Drupal.behaviors.sPage=function(b){var a=$(a);$(".s-page-container:not(.sPage-processed)",b).addClass("sPage-processed").each(function(){var c=$(this);$("table",c).each(function(){var d=$(this);var f=d.attr("cellpading");var e=d.attr("cellspacing");$("td",d).each(function(){var g=$(this);if(f>0){g.css({padding:f+"px"})}if(e>0){g.css("padding",e+"px")}})});$(".s-page-mini-toc-select",c).bind("click",function(){var j=$(this).parent();
var f=$(this);var h=$(".s-page-mini-toc",j);if(h.length){h.toggle();f.toggleClass("active")}else{var g=$(this).attr("id");var e=g.split("-");var d=e[1];$.ajax({type:"GET",url:"/page/"+d+"/toc",dataType:"json",success:function(k){j.append(k.html);f.addClass("active")}})}});$(".table-of-contents .reorder-btn",c).bind("click",function(){var f=$(this).parent();var d=$("#s-page-subpage-list .tabledrag-handle",f);var e=$("#s-page-subpages-form .submit-span-wrapper",f);if(d.is(":visible")){d.hide();e.hide()}else{d.show();e.css("display","inline-block")}})});$(".s-page-actions-links:not(.sPage-processed)",b).addClass("sPage-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})});$("td.indented-row:not(.sPage-processed)",b).addClass("sPage-processed").each(function(){var c=$(this);var d=$("#s-page-nav-form");addPageActionLinkBehavior(c,d);fixRowSpacing(d)});$("td.root-row:not(.sPage-processed)",b).addClass("sPage-processed").each(function(){var c=$(this);
var d=$("#s-page-nav-form");addPageActionLinkBehavior(c,d);fixRowSpacing(d)});$("#s-page-subpage-list:not(.sPage-processed)",b).addClass("sPage-processed").each(function(){$("tr",$(this)).each(function(){$(".action-links-wrapper",$(this)).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})})})};if(Drupal.tableDrag){Drupal.tableDrag.prototype.row.prototype.markChanged=function(){var a=$(this.element);var b=$(this.table);$("td",a).each(function(){var c=$(this);var d=$(".indentation",c).length;adjustRowClasses(c,d,a)});$(".save-menu").show();return false}}function addPageActionLinkBehavior(a,b){$(".s-page-nav-links-unfold",a).bind("click",function(){var d=$(this).parent();var c=$(this);$(".s-page-nav-link-items",b).not($(".s-page-nav-link-items",d)).each(function(){$(this).hide()});$(".s-page-nav-link-items",d).toggle();if($(".s-page-nav-link-items",d).is(":visible")){c.addClass("active");$(".s-page-nav-links-unfold",b).not($(".s-page-nav-links-unfold",d)).removeClass("active")}else{c.removeClass("active")
}});$(".s-page-nav-link-items a",a).bind("click",function(){$(".s-page-nav-link-items",b).hide();$(".s-page-nav-links-unfold",b).removeClass("active")});$("body").bind("click",function(c){var d=$(c.target);var f=d.parents("tr");if(f.length==0){$(".s-page-nav-link-items",b).hide();$(".s-page-nav-links-unfold").removeClass("active")}else{var e=$(".s-page-nav-link-items",f).is(":visible");if(!e){$(".s-page-nav-link-items").hide();$(".s-page-nav-links-unfold").removeClass("active")}}})}function remPageActionLinksBehavior(a){$(".s-page-nav-links-unfold",a).unbind()}function adjustRowClasses(b,c,a){if(c==0&&!b.hasClass("row-weight")){if(b.hasClass("indented-row")){b.removeClass("indented-row");b.addClass("root-row");b.removeClass("sPage-processed");remPageActionLinksBehavior(a);actionLinks=sPageWrapActionLinks(createPageActionLinks(b,a,1),"junior");$(".s-page-action-links",b).remove();$("a.tabledrag-handle",b).after(actionLinks);Drupal.attachBehaviors(a)}}else{if(!b.hasClass("row-weight")){if(b.hasClass("root-row")){b.removeClass("root-row");
b.addClass("indented-row");b.removeClass("sPage-processed");remPageActionLinksBehavior(a);actionLinks=sPageWrapActionLinks(createPageActionLinks(b,a,0),"junior");$(".s-page-action-links",b).remove();b.prepend(actionLinks);Drupal.attachBehaviors(a)}}}}function fixRowSpacing(a){$(".root-row",a).each(function(){var b=$(this);var c=b.parents("tr");var d=c.prev();$(".row-data",d).css("padding-bottom","10px")});$(".indented-row",a).each(function(){var b=$(this);var c=b.parents("tr");var d=c.prev();$(".row-data",d).css("padding-bottom","0px")})}function createPageActionLinks(l,k,a){var e=$("#s-page-nav-form").attr("class");var j=e.split("-");var f=j[2];var n=j[3];var h=$(".page-pageid",k).val();var d=parseInt($(".page-weight",k).val());var c="";if(a==0){var b=null;var g=false;k.prevAll().each(function(){if(!g){var o=$(this);var p=$(".root-row",o);if(p.length){b=o;g=true}}});var m=$(".page-pageid",b).val();c+='<li class="action-create-page-above"><a href="/'+f+"/"+n+"/materials/pages/create?r=0&p="+m+"&w="+d+'">'+Drupal.t("Create page above")+"</a></li>";
c+='<li class="action-create-page-below"><a href="/'+f+"/"+n+"/materials/pages/create?r=0&p="+m+"&w="+(d+1)+'">'+Drupal.t("Create page below")+"</a></li>";c+='<li class="action-delete"><a href="/page/'+h+'/delete">'+Drupal.t("Delete page")+"</a></li>";return c}else{c+='<li class="action-create-page-above"><a href="/'+f+"/"+n+"/materials/pages/create?r=0&p=0&w="+d+'">'+Drupal.t("Create page above")+"</a></li>";c+='<li class="action-create-page-below"><a href="/'+f+"/"+n+"/materials/pages/create?r=0&p=0&w="+(d+1)+'">'+Drupal.t("Create page below")+"</a></li>";c+='<li class="action-create-subpage-below"><a href="/'+f+"/"+n+"/materials/pages/create?r=0&p="+h+"&w="+d+'">'+Drupal.t("Create subpage below")+"</a></li>";c+='<li class="action-delete"><a href="/page/'+h+'/delete">'+Drupal.t("Delete page")+"</a></li>";return c}}function sPageWrapActionLinks(c,b){var a='<div class="s-page-action-links s-page-action-links-wrapper-'+b+'">';a+='<div tabindex="0" role="button" class="s-page-nav-links-unfold" href="#"><span class="action-links-unfold-text"><span class="visually-hidden">'+Drupal.t("Click to toggle options.")+"</span></span></div>";
a+='<ul class="s-page-nav-link-items" style="display: none;">';a+=c;a+="</ul>";a+="</div>";return a}function sPageOnDeleteCallback(c,a,b){window.location.href="/"+c.path;return false}Drupal.behaviors.sAttachment=function(a){$(".attachments-video-thumbnails-play:not(.sAttachment-processed)",a).addClass("sAttachment-processed").each(function(){var b=$(this);b.bind("click",function(){var d=b.parents(".attachments-video");var c=$(".video-video",d);d.after(c);c.show();d.hide();thePopup=Popups.activePopup();if(thePopup!=null){Popups.resizeAndCenter(thePopup)}return false})});$(".embed-cover:not(.sAttachment-processed)",a).addClass("sAttachment-processed").each(function(){$(this).click(function(){var d=$(this),c=d.siblings(".embed-content:first");d.hide();d.siblings(".embed-title").hide();if(c.length){var b=c.get(0),e=null;c.show();$.each(b.childNodes,function(f,g){if(g.nodeType==8){e=g.nodeValue}});if(e){c.html(e)}}})});$(".attachments-link:not(.sAttachment-processed)",a).addClass("sAttachment-processed").each(function(){var c=$(this);
var b=$(".attachment-link-popup",c);c.bind("mouseenter",function(){if(b.length){b.show()}}).bind("mouseleave",function(){if(b.length){b.hide()}});b.bind("mouseenter",function(){$(this).hide()})})};Drupal.behaviors.s_user=function(b){$("#s-user-custom-notifications-form:not(.sUser-processed)").addClass("sUser-processed").each(function(){var d=$(this);var e=$(".select-all",d);e.click(function(){var f=$(this).is(":checked");$(".realm-setting",d).each(function(){$(this).prop("checked",f)})});$(".edit-select-all-wrapper",d).click(function(){$("input",this).click()});$(".realm-setting").each(function(){var f=$(this);f.change(function(){if(!f.attr("checked")&&e.attr("checked")){e.prop("checked",false)}})});$(".cancel-btn",d).click(function(j){var h=$(".setting-name",d).val();var f=$(".original-setting",d).html();$("select[name="+h+"]").selectmenu("value",f);var g=Popups.activePopup();if(g!=null){g.close()}j.preventDefault()})});$(".notifications-header:not(.sUser-processed)").addClass("sUser-processed").each(function(){if(Drupal.settings.s_user!="undefined"&&typeof Drupal.settings.s_user.notif_defaults!="undefined"){var d=Drupal.settings.s_user;
...
$(".timezone-select-time",d).show();$("#edit-timezone-select-type",d).val("time")});$("#edit-user-name-first-preferred").on("keydown paste input",function(j){var l=$(this);var k=!!l.val().length;var h=l.closest(".name-first-preferred-wrapper");var g=$(".use-name-first-preferred-wrapper");var f=!g.hasClass("hidden");if(k!=f){g.toggleClass("hidden",f);h.toggleClass("has-preferred-first-name",k)}})});$(".s-js-name-title-wrapper:not(.sUser-processed)",b).addClass("sUser-processed").each(function(){var d=$(this),e=$(".s-js-name-title-custom",d);$(".s-js-name-title-select",d).change(function(f){if($(this).val()=="custom"){d.addClass("s-js-name-title-custom-enabled")}else{d.removeClass("s-js-name-title-custom-enabled");e.val("")}}).triggerHandler("change")});if($(".logout-exec").text()=="1"){var a=location.href;index=a.indexOf("settings/");var c="/logout?";if(Drupal.settings.s_common.hasOwnProperty("logout_token")){c+="ltoken="+Drupal.settings.s_common.logout_token+"&"}c+="destination=home.php?deleted";
newUrl=a.substring(0,index)+c;location.href=newUrl}$(".profile-picture-wrapper:not(.sUser-processed)",b).addClass("sUser-processed").each(function(){var g=$(this);var e=$(".edit-profile-picture-hover",g);var d=$(".profile-picture",g);var f=$("#profile-picture-uploader-wrapper",g);e.bind("click",function(){if(f.is(":visible")){f.hide()}else{f.show()}});$("body").bind("click",function(j){var h=$(j.target);if(!h.hasClass("profile-picture-wrapper")&&h.parents(".profile-picture-wrapper").length==0){f.hide()}});d.bind("s_profile_picture_uploaded",function(j,h){$("img",$(this)).attr("src",h).removeAttr("height");f.hide()})});$(".push-remove:not(.sUser-processed)",b).addClass("sUser-processed").bind("click",function(g){g.preventDefault();var f=$(this);var d='<span class="confirm-remove-device-name">'+f.siblings(".push-os").html()+"</span>";var h='<span class="confirm-message">'+Drupal.t("Are you sure you want to deactivate !device_name?",{"!device_name":d})+"</span>";sCommonConfirmationPopup({title:Drupal.t("Deactivate Device"),body:h,extraClass:"push-remove",confirm:{text:Drupal.t("Deactivate"),func:function(){$.ajax(f.attr("href"),{data:{ajax:true},success:function(j){if(j.body){$("#content-wrapper").html(j.body);
if(j.messages){var e=$("#main-content-wrapper");e.children(".messages").remove();e.prepend(j.messages)}Drupal.attachBehaviors($("#main-content-wrapper"))}},complete:function(){Popups.activePopup().close()}})}}})})};function repositionZClipboard(){var b=$("#invite_link").offset();var a=$(".popups-box").offset();$(".zclipboard").css("left",b.left-a.left);$(".zclipboard").css("top",b.top-a.top)}Drupal.behaviors.sCourseMaterialsFolders=function(a){$(".materials-folder.item-info:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var d=$(this);var c=$(".folder-title a",d);var e=$(".folder-description",d);if(e.hasClass("description-clickable")){e.bind("click",function(f){if(!$(f.target).is("a")){c[0].click()}})}});(function(){function d(e){e.closest("#folder-contents-table").find("tbody.ui-sortable").each(function(g,f){$(f).sortable("refresh")})}function c(g,o){var h=g.siblings(".folder-subtree"),l=h.find(".action-links-wrapper"),m=g.parent().find(".s-js-folder-description"),n=g.parent().find(".folder-title"),o=o||false,e=g.closest(".material-row-folder").attr("id").split("-")[1];
var k="easeInQuad",f=300;function j(p){if(p){descFunc="slideUp";subtreeFunc="slideDown"}else{descFunc="slideDown";subtreeFunc="slideUp"}m[descFunc]({duration:f,easing:k});l.hide();h[subtreeFunc]({duration:f,easing:k,done:function(){l.show()}})}if(o){g.find(".visually-hidden").text(Drupal.t("Collapse folder."));if(h.length){j(true)}else{$loader=$('<img class="pending" src="/sites/all/themes/schoology_theme/images/ajax-loader.gif" alt="'+Drupal.t("Loading")+'" />');h=$('<div class="folder-subtree"></div>');g.parent().append(h);n.after($loader);$.ajax({dataType:"json",url:window.location.pathname,data:{ajax:1,f:e},success:function(r){r=$(r);$("form>div",r).unwrap();$("[name=form_build_id], [name=form_token], [name=form_id]",r).remove();$loader.remove();h.hide().html(r);j(true);Drupal.attachBehaviors(h);$("tr td.actions",h).sActionLinks({hidden:false,wrapper:".action-links-wrapper"});var p=$(document).data("sCourseMaterialsFoldersActionPush");if(p&&p.length){var s=p.pop();var q=$("#f-"+s+" > td.folder-contents-cell > .folder-expander");
if(!q.hasClass("expanded")){q.click()}$(document).data("sCourseMaterialsFoldersActionPush",p)}else{d(h)}},error:function(){h.html('<div class="error">'+Drupal.t("There was an error while loading the folder content. Please reload this page and try again.")+"</div>");d(h)}})}}else{g.find(".visually-hidden").text(Drupal.t("Expand folder."));j(false)}}$(".folder-contents-cell .folder-expander:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var e=$(this);e.click(function(){var f=!e.hasClass("expanded");e.toggleClass("expanded");c(e,f)})})})();if($("#folder-contents-table").length){$("body:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){$(document).bind("popups_open_path",function(f,e,c){var g=$(e).parents();if(g.hasClass("action-links-wrapper")||g.closest(".action-links-wrapper").length){var d=[];g.closest(".subtree-folder-contents-table").parents("tr.material-row-folder").each(function(){d.push($(this).attr("id").split("-")[1])
});if(d&&d.length){$(document).data("sCourseMaterialsFoldersActionPush",d)}else{$(".folder-expander.expanded").trigger("click")}location.hash="foldersexpanded="+d.join(",")}if(g.closest("#course-materials-action-links-inline").length){var d=[];var h=g.closest("#course-materials-action-links-inline").data("materialsRowAddId");if(h){$("#"+h).parents("tr.material-row-folder").each(function(){d.push($(this).attr("id").split("-")[1])})}if(d.length){location.hash="foldersexpanded="+d.join(",")}}}).bind("popups_form_success",function(e,c,f){var d=$(document).data("sCourseMaterialsFoldersActionPush");if(d&&d.length){var g=d.pop();var h=$("#f-"+g+">td.folder-contents-cell>.folder-expander");if(!h.hasClass("expanded")){h.click()}$(document).data("sCourseMaterialsFoldersActionPush",d)}})});if(location.hash.match("foldersexpanded")){var b=location.hash.split("foldersexpanded=")[1].split(",");b.forEach(function(c){var d=c;var e=$("#f-"+d+">td.folder-contents-cell>.folder-expander");if(!e.hasClass("expanded")){e.click()
}})}}$("#s-generic-post-new-display-view:not(.sCourseMaterialsFolders-processed),#folder-contents-table:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var f=$(this);if(f.attr("id")=="folder-contents-table"){$("tr td.actions").sActionLinks({hidden:false,wrapper:".action-links-wrapper"});var d=$(".materials-top .course-content-action-links .action-links");var e=$('<div id="course-materials-action-links-inline" class="hidden"></div>');$("body").append(e);var c=null;f.click(function(k){var j=$(k.target);if(j.parent(".materials-row-add-line").length){var n=j.closest(".materials-row-add").attr("id");var m=n.split("-");var g=m[3];var h=m[4];if(c&&n==c.closest(".materials-row-add").attr("id")){e.hide();c=null;return}c=j;var l=j.offset();e.empty().data("materialsRowAddId",n).append(d.clone(true).show()).show().css({position:"absolute",top:l.top+j.height(),left:l.left});$("li",e).each(function(){var q=$(this);var p=$("a",q);var o=q.attr("class");
if(p[0]==undefined){return true}var s=p[0].pathname;s=s.replace(/^\//,"");var t=p[0].search;if(!t.length){var r={}}else{var r=getQueryParams(t)}switch(o){case"action-import-library":if(g>0){r.topic_nid=g}else{delete r.topic_nid}r.fweight=h;p.attr("href","/"+s+"?"+jQuery.param(r));break;case"action-find-resources":q.remove();break;default:if(g==0&&!sCourseMaterialsDisplayIsWithoutIndex()){if(o!="action-create-folder"){q.remove();return}else{q.addClass("folder-no-materials")}}r.f=g;r.fweight=h;p.attr("href","/"+s+"?"+jQuery.param(r));break}})}});$("body").click(function(h){var g=$(h.target);if(g.parent(".materials-row-add-line").length==0){e.hide();c=null}})}$(".has-view-rule:not(.completed)",f).click(function(){var g=$(this).parents(".type-document:first");var h=g.attr("id").split("-")[1];$.ajaxSecure({url:"/course/materials/"+h+"/view_completion"})})});$("#closeable-message-s_course_find_resources:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){$(document).bind("s_common_closeable_message_closed",function(f,c){if(c=="s_course_find_resources"){var d='<div class="fake-cluetip"><span class="arrow-top"><span>'+Drupal.t("You can find resources for your course in this menu.")+"</div>";
var g=$(".course-content-action-links").offset();$("body").append(d);$(".fake-cluetip").css({position:"absolute",left:g.left+$(".course-content-action-links").width(),top:g.top});setTimeout(function(){$(".fake-cluetip").remove()},2000)}})});$("#s-course-materials-folder-create-form:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var f=$(this);var d=$(".rules-msg",f);var c=$(".availability-start-wrapper",f);var e=$(".availability-add-end",f);var h=$(".availability-end-wrapper",f);var g=$("#edit-apply-to-children-wrapper",f);e.click(function(){$(this).remove();h.show();sPopupsResizeCenter()});if(typeof sCommonAdvancedOptions=="object"){sCommonAdvancedOptions.registerEvent(f.attr("id"),"custom-fields","sCourseMaterialsFolders",function(j){if(j.hasClass("adv-option-on")){$("#folder-custom-fields-wrapper",f).show()}else{$("#folder-custom-fields-wrapper",f).hide()}sPopupsResizeCenter()})}$("#edit-availability",f).bind("change",function(){var j=parseInt($(this).val());
switch(j){case 1:g.show();if(d.length){d.hide()}break;case 2:g.hide();if(d.length){d.show()}break;case 3:g.hide();if(d.length){d.show()}break;case 4:g.hide();if(d.length){d.show()}e.remove();h.show();break;default:break}sPopupsResizeCenter()});$("#edit-availability",f).trigger("change")});$("#s-course-materials-folder-completion-form:not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var c=$(this);hasDueList=new Array();$(".add-rule",c).click(function(){if(!$(this).hasClass("disabled")){$("#edit-rules-submitter",c).trigger("click")}});$(".auto-populate",c).click(function(){$(".ahah-populate-submitter",c).trigger("click")});sCourseMaterialsSetupRules(c,true);sCourseMaterialsSetupRemove("rule-option",c);$(document).ajaxSend(function(f,g,d){if(d.url=="/course/new_rule"){$(".add-rule",c).addClass("disabled")}});$(document).ajaxComplete(function(g,h,f){if(f.url=="/course/new_rule"||f.url=="/course/remove_rule"||f.url=="/course/populate_rule"){sCourseMaterialsSetupRules(c,false,(f.url=="/course/remove_rule"));
sCourseMaterialsSetupRemove("rule-option",c);var d=$(".add-rule",c);if(f.url=="/course/populate_rule"){d.hide()}else{if(f.url=="/course/remove_rule"&&!d.is(":visible")){d.show()}}$(".add-rule",c).removeClass("disabled")}sPopupsResizeCenter()})})};function sCourseMaterialsSetupRemove(b,a){$("."+b+":not(.sCourseMaterialsFolders-processed)",a).addClass("sCourseMaterialsFolders-processed").each(function(){var c=$(this);$(".delete-btn",c).click(function(){var e=c.attr("id");var d=c.hasClass("existing")?"1":"0";$(".rule-remove-existing",a).val(d);$(".rule-remove-id",a).val(parseInt(e));$(".ahah-remove-rule",a).click()})})}function sCourseMaterialsSetupRules(b,c,g){if(typeof g=="undefined"){g=false}if(typeof Drupal.settings.s_course=="undefined"&&typeof Drupal.settings.s_course.type_options=="undefined"){return}var d=Drupal.settings.s_course.type_options;var h=Drupal.settings.s_course.types;var j=Drupal.settings.s_course.max_pts;var k=Drupal.settings.s_course.constants;var a=Drupal.settings.s_course.due_events;
var f=Drupal.settings.s_course.comments_disabled;var e=Drupal.settings.s_course.submit_disabled;$(".rule-item:not(.sCourseMaterialsFolders-processed)",b).addClass("sCourseMaterialsFolders-processed").each(function(){var o=$(this);var m=o.parents(".rule-option:first");var n=m.attr("id");var l=true;o.change(function(r){var q=o.val();var t=$(".rule-action",m);var s=h[q];if(typeof a[q]!="undefined"&&a[q]>0){$(".has-due-event-warning",b).show();hasDueList[parseInt(n)]=true}else{hasDueList[parseInt(n)]=undefined}if(!hasDueList.join("").length){$(".has-due-event-warning",b).hide()}var p=$("option:selected",t).val();t.empty();$(".action-options option").each(function(){var u=$(this);var v=u.val();if(v==k.comment&&f[q]==true){return true}if((v==k.submit||v==k.score)&&e[q]==true){return true}if($.inArray(parseInt(v),d[s])>-1){var w=u.clone().appendTo(t);if(w.val()==p){w.attr("selected","selected")}}});if((!l||!c)&&!g){t.val($("option:visible:first",t).val())}else{l=false}$(".max-pt",m).hide();$(".rule-icon",m).html(Drupal.settings.s_course.rule_icons[o.val()]);
sPopupsResizeCenter()});o.change()});$(".rule-action:not(.sCourseMaterialsFolders-processed)",b).addClass("sCourseMaterialsFolders-processed").each(function(){var m=$(this);var l=m.parents(".rule-option:first");m.change(function(){var n=$(".rule-item",l).val();if(m.val()==k.score){$(".max-pt-num",l).html(j[n]);$(".max-pt",l).show()}else{$(".max-pt",l).hide()}sPopupsResizeCenter()});m.change()})}Drupal.behaviors.sCourse=function(a){if($("body").hasClass("s-enable-mathml")){s_renderMath()}$(".assignments-container:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){setupAssignmentPaging(this)});$(".subtree-folder-contents-table:not(.sCourse-processed), .planner-right-contents-table:not(.sCourse-processed), #folder-contents-table:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var b=$(this);sCourseEnableContentReorder($(">tbody",b))});$(".access-code:not(.sCourse-processed)").addClass("sCourse-processed").each(function(){var b=this;$(".access-delete",b).click(function(){var d=window.location.pathname.substring(1);
var c=d.split("/")[1];$.ajaxSecure({url:"/enrollment/code/visibility/course/"+c+"/hide",dataType:"json",type:"GET",success:function(f,e){$(b).hide()}})})});$("#course-events:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var c=$(this);var e=window.location.pathname.substring(1);var d=e.split("/")[1];$.ajax({url:"/course/"+d+"/calendar_ajax"+(window.location.search.length?window.location.search+"&":"?")+"original_q="+e,dataType:"json",type:"GET",success:function(g,f){$(".more-loading",c).remove();c.append($(g).children());if(window.location.search.match("mini=")){$("#event-calendar",b).click()}sAttachBehavior("sCourse",c);sAttachBehavior("sCommonInfotip",c);c.show()}});var b=$("h3#event-selector",c);$("#event-calendar",b).click(function(){var g=new Popups.Popup();var f='<div id="fcalendar" style="width: 800px;"></div>';var h={popup_cancel:{title:Drupal.t("Close"),func:function(){g.close()}}};g.extraClass="popups-extra-large calendar-popup-mini";var j=g.open(Drupal.t("Calendar"),f,h);
Drupal.attachBehaviors($("#"+String(j.id)+""));Drupal.behaviors.sCommonMediaFileIframeUseRelativeUrl($("#"+String(j.id)+""));$("#share-calendar-option-containter .share-calendar-option").insertAfter("#fcalendar");sPopupsResizeCenter()})});$("div#course-profile-selector:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var b=$(this);$("li",b).click(function(){var c=$(this);if(c.attr("id")=="selector-materials"){$("#course-profile-materials").show();$("#course-profile-updates").hide()}if(c.attr("id")=="selector-updates"){$("#course-profile-updates").show();$("#course-profile-materials").hide()}$("li.active",b).removeClass("active");c.addClass("active")})});$("div#important-post:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var b=$(this);$("a.important-remove-hidden",b).bind("click",function(){$(this).parent().parent().find("form").submit();return false})});$(".course-info-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var d=$(this);
var c=$(".course-info-full",d);var b=$(".course-info-less",d);$(".more-link",d).click(function(){b.hide();c.show()});$(".less-link",d).click(function(){b.show();c.hide()})});$(".notification-settings:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){sUserSetupRealmNotifButton($(this))});$(".profile-picture-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var e=$(this);var c=$(".edit-profile-picture-hover",e);var b=$(".profile-picture",e);var d=$("#profile-picture-uploader-wrapper",e);c.bind("click",function(){if(d.is(":visible")){d.hide()}else{d.show()}});$("body").bind("click",function(g){var f=$(g.target);if(!f.hasClass("profile-picture-wrapper")&&f.parents(".profile-picture-wrapper").length==0){d.hide()}});b.bind("s_profile_picture_uploaded",function(g,f){$("img",$(this)).attr("src",f).removeAttr("height");d.hide()})});$("li.assignment .action-links-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})
});$("#link-sections-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:"#link-sections-wrapper"})});$("#s-course-settings:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"})});$("#course-profile-materials .materials-top:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var b=$(this);$("#print-view",b).bind("click",function(){$("body").addClass("print-view");var c=$('<div id="print-return"><span>'+Drupal.t("Return to previous page")+"</span></div>");c.click(function(){location.reload()});$("body").prepend(c);$("#course-profile-materials .ui-sortable").sortable("destroy");window.print()});$("#toolbar-options-wrapper",b).addClass("sCourse-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:"#toolbar-options-wrapper"})});$(".course-content-action-links",b).each(function(){$(this).sActionLinks({hidden:false,wrapper:".action-links-wrapper"});
$(".action-links.has-material-apps",this).on("click",".action-lti-app",function(g){g.preventDefault();var d="/tinymceinsertresourcesapp?r="+String($(this).data("realm"))+"&id="+String($(this).data("realm_id"))+"&a="+String($(this).data("app_nid"))+"&context=materials";var f=getQueryParams($("a",this).prop("href"));if(f&&typeof f.f!="undefined"){d+="&f="+String(f.f)}if(f&&typeof f.fweight!="undefined"){d+="&fweight="+String(f.fweight)}Popups.saveSettings();var c=Popups.activePopup();var j=Popups.options({ajaxForm:false,extraClass:"popups-extra-large popups-insert-library",updateMethod:"none",href:d,hijackDestination:false,disableCursorMod:true,disableAttachBehaviors:false});var h=sCommonGetSetting("s_app","cookie_preload_urls",$(this).data("app_nid"));if(h){sAppMenuCookiePreloadRun($(this).data("app_nid"),h,function(){sAppLauncherClearCache($(this).data("app_nid"));sAppMenuCookiePreloadDelete($(this).data("app_nid"));Popups.openPath(this,j,c)})}else{Popups.openPath(this,j,c)}})})});$(".past-assignments-grading-period .clickable:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){$(this).click(function(){var b=$(">ul",$(this).parent());
if(b.css("display")=="none"){$(this).parent().removeClass("assignments-hidden");b.show()}else{$(this).parent().addClass("assignments-hidden");b.hide()}})});$(".s-course-editor-wrapper .save-and-continue-btn:not(.sCourse-processed)",a).addClass("sCourse-processed").bind("click",function(){var c=$(this).parents(".s-course-editor-wrapper");var b=c.find("form");b.submit();return false});$("#menu-s-main a.course-materials-left-menu:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var e=$(this),b=$(".materials-dropdown-arrow",e),c=$("#course-materials-dropdown"),d=c.find(".item-list ul").length>0;e.after(c);if(d){b.removeClass("hidden").click(function(){var g=$(this);var f=c.is(":hidden");if(f){$("body").bind("click.sCourseMaterialsHandle",function(k){var j=$(k.target);var h=c.is(":hidden");if(!h&&j!=c&&j.parents("#course-materials-dropdown").length==0){$(".materials-dropdown-arrow",e).click()}});c.show();$(this).addClass("active")}else{c.hide();$(this).removeClass("active");
$("body").unbind("click.sCourseMaterialsHandle")}return false})}else{b.hide()}});$("#right-column .reminders-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){sCourseSetupTodoList($(this))});if(!$("body").hasClass("anonymous")){$(".gen-post-link:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){var b=$(this);b.on("click",function(c){if(!b.hasClass("embed-cover")&&!genPostLink.hasClass("media-player-popup")){c.preventDefault()}sCourseTrackGenericPostView($(this))})})}$(".s-js-course-area-switcher .action-links-wrapper:not(.sCourse-processed)",a).addClass("sCourse-processed").each(function(){$(this).sActionLinks({hidden:false,wrapper:".badge-action-links"})});(function(b){$(".s-js-course-materials-full:not(.sCourse-processed)",b).addClass("sCourse-processed").each(function(){var e=$(this),k=e.find(".s-js-materials-filter-wrapper .action-links-wrapper"),q=k.find(".action-links-unfold-text"),u=e.find(".s-js-options-action-links-outer"),t=null;
function g(w){u.find(".s-js-content-option").hide();u.find(".s-js-content-option-"+w).show()}function p(x){t=k.find(".s-js-material-filter-"+x.replace(/_/g,"-"));var w=k.data("filter"),y=t.data("filter");if(w!=y){k.data("filter",y);k.find(".selected").removeClass("selected");t.closest("li").addClass("selected");q.text(t.text())}}function j(){if(t&&t.length){var x=n(),w=t.data("filter");if(x!=w){p(x)}sAngular.trigger("sCourseMaterialsFilterChanged",{filter:t.data("filter"),url:t.attr("href")})}}function v(w,x){var y="s-js-course-materials-full";w+=(w.indexOf("?")?"&":"?")+"ajax=1&style=full";sToggleActiveLoader(y,e);$.ajax({url:w,success:function(C){var A=$(C),B=e.find(".s-js-materials-body"),z=A.find(".s-js-materials-body");if(B.length){B.replaceWith(z)}else{e.append(z)}Drupal.attachBehaviors(e.find(".s-js-materials-body"));sAngular.trigger("sCourseMaterialsFilterContentRefreshed",x)},complete:function(){sToggleActiveLoader(y)}})}function n(){var w="all",x=/filter_type=(\w+)/.exec(window.location.hash);
if(x){w=x[1]}return w}function f(w){window.location.hash="!filter_type="+w}$(window).on("hashchange",function(w){j()});sAngular.on("sCourseMaterialsFilterChanged",function(y){var x=y.filter,w=y.url;v(w,x)});var c={};var d={updateMethod:"callback",onUpdate:function(w,x,y){j();Popups.close();return false}};var h={".materials-item-actions .action-publish a":{extraClass:"popups-small popups-publish"},".materials-item-actions .action-unpublish a":{extraClass:"popups-small popups-unpublish"},".materials-item-actions .action-delete a":{extraClass:"popups-small popups-action-item"},".materials-item-actions .action-move a":{extraClass:"popups-small popups-action-item"},".materials-item-actions .action-copy a":{extraClass:"popups-large popups-copy popups-action-item"},".materials-item-actions .action-distribute a":{extraClass:"popups-large popups-copy popups-action-item"},".materials-item-actions .action-library-save a":{extraClass:"popups-large"},".materials-item-actions .action-edit-properties a":{extraClass:"popups-large"},".materials-item-actions .s-js-locked-resource-link-diff":{extraClass:"popups-extra-large linked-content-diff-view"},".materials-item-actions .s-js-unlink-node":{extraClass:"popups-small unlink-popup"},".materials-item-actions .action-edit-link a":{extraClass:"popups-large popups-action-item popups-add-link"}};
var m=!!sCommonGetSetting("s_realm_info","csm_realm_id");if(m){h[".dr:not(.type-common-assessment) > * > .materials-item-actions .action-edit a"]={extraClass:"popups-large popups-action-item"};h[".type-common-assessment .materials-item-actions .action-edit a"]={extraClass:"popups-extra-large popups-action-item"}}else{h[".materials-item-actions .action-edit a"]={extraClass:"popups-large popups-action-item"}}var o={".materials-folder-actions .action-edit a":{extraClass:"popups-large popups-action-item",targetSelectors:["#s-course-materials-folder-contents-form"]},".materials-folder-actions .action-publish a":{extraClass:"popups-small popups-action-item",targetSelectors:["#s-course-materials-folder-contents-form"]},".materials-folder-actions .action-unpublish a":{extraClass:"popups-small popups-action-item",targetSelectors:["#s-course-materials-folder-contents-form"]},".materials-folder-actions .action-delete a":{extraClass:"popups-small popups-action-item",updateMethod:"reload"},".materials-folder-actions .action-copy a":{extraClass:"popups-large popups-action-item popups-copy",disableInputFocus:true,doneTest:"course/.+?/materials($|[^/].*)",updateMethod:"reload"},".materials-folder-actions .action-distribute a":{extraClass:"popups-large popups-copy popups-action-item"},".materials-folder-actions .action-move a":{extraClass:"popups-small popups-action-item",targetSelectors:["#course-profile-materials-folders"],updateMethod:"reload",doneTest:".+"},".materials-folder-actions .action-library-save a":{extraClass:"popups-large popups-action-item",hijackDestination:true,updateSource:"final",doneTest:"course/.+?/materials.*",updateMethod:"reload",},".materials-folder-actions .action-completion a":{extraClass:"popups-large popups-action-item student-completion-popup"}};
sAngular.on("sCourseMaterialsFilterContentRefreshed",function(x){g(x);if(typeof c[x]=="undefined"){c[x]=null;var w={};switch(x){case"all":w=$.extend({},o,h,{".materials-item-actions .action-convert a":{extraClass:"popups-small"},".materials-item-actions .action-edit-xlarge a":{extraClass:"popups-extra-large popups-action-item"},".materials-item-actions .action-rename a":{extraClass:"popups-small popups-action-item"},".materials-item-actions .action-remove a":{extraClass:"popups-small popups-action-item"},".materials-item-actions .action-package-delete a":{extraClass:"popups-small popups-package-delete"},".materials-item-actions .action-edit-package-props a":{extraClass:"popups-extra-large popups-package-edit-props"},".materials-item-actions .action-edit-launch-props a":{extraClass:"popups-small popups-package-edit-launch-props"},".materials-item-actions .action-view-progress a":{extraClass:"popups-extra-large popups-package-progress"},".materials-item-actions .action-copy a":{extraClass:"popups-large popups-action-item popups-copy",disableInputFocus:true,doneTest:"course/.+?/materials($|[^/].*)",updateMethod:"reload",},".materials-item-actions .action-move a":{extraClass:"popups-small popups-action-item",targetSelectors:["#course-profile-materials-folders"],updateMethod:"reload",doneTest:".+"},".materials-item-actions .action-library-save a":{extraClass:"popups-large popups-action-item",hijackDestination:true,updateSource:"final",doneTest:"course/.+?/materials.*",updateMethod:"reload",}});
break;case"assessments":case"assignments":case"discussion":w=$.extend({},h,{".view-ind-assign":{extraClass:"popups-small",disableInputFocus:true}});break;case"scorm":w=$.extend({},h,{".materials-item-actions .action-edit-package-props a":{extraClass:"popups-extra-large popups-package-edit-props"},".materials-item-actions .action-edit-launch-props a":{extraClass:"popups-small popups-package-edit-launch-props"},".materials-item-actions .action-view-progress a":{extraClass:"popups-extra-large popups-package-progress"}});break;case"web":case"album":w=$.extend({},h);break;case"pages":w=$.extend({},h,{".materials-item-actions .action-edit-xlarge a":{extraClass:"popups-extra-large"},".materials-item-actions .action-add-to-folder a":{extraClass:"popups-small"}});break;case"documents_files":case"documents_links":case"documents_external_tools":w=$.extend({},h,{".materials-item-actions .action-rename a":{extraClass:"popups-small popups-action-item"},".materials-item-actions .action-copy a":{extraClass:"popups-large popups-action-item popups-copy",doneTest:"course/.+?/materials($|[^/].*)"}});
break;case"common_assessments":case"new_test_quiz":w=$.extend({},h,{".materials-item-actions .action-edit a":{hidden:false,extraClass:"popups-large popups-action-item",wrapper:".action-links-wrapper"},".materials-item-actions .action-publish a":{hidden:false,extraClass:"popups-small popups-publish",wrapper:".action-links-wrapper"},".materials-item-actions .action-move a":{hidden:false,extraClass:"popups-small popups-action-item",wrapper:".action-links-wrapper"},});break}if(!$.isEmptyObject(w)){var z=x=="all"?".s-js-full-view":".s-js-filtered-view-"+x.replace(/_/g,"-"),y=sCommonGetSetting("popups","links")||{};$.each(w,function(A,B){if(typeof y[A]=="undefined"){B=$.extend({},d,B);e.on("click",z+" "+A,B,function(C){C.preventDefault();return Popups.clickPopupElement(this,Popups.options(C.data))})}})}}});k.sActionLinks({hidden:false});k.on("click",".s-js-material-filter-link",function(x){x.preventDefault();var w=$(this).data("filter");sStatsRecordEvent("course:materials:filter_clicked:"+w);
p(w);f(w)});var s=k.find(".selected"),r=n();if(r!="all"){p(r);j()}else{if(s.length){var l=s.find(".s-js-material-filter-link").data("filter");p(l);sAngular.trigger("sCourseMaterialsFilterContentRefreshed",l)}else{sAngular.trigger("sCourseMaterialsFilterContentRefreshed","all")}}});$(".s-js-materials-filter-more-link:not(.sCourse-processed)",b).addClass("sCourse-processed").each(function(){var d=$(this),c="s-js-materials-filter-more";d.sInfiniteScroll({loadMore:function(){d.trigger("click")}}).on("click",function(j){j.preventDefault();var f=d.attr("href"),h=d.closest(".s-js-course-materials-full"),g=h.find(".s-js-materials-body");sToggleActiveLoader(c,d);$.ajax({url:f,success:function(l){var m=$(l),e=m.find(".s-js-filtered-view-list"),k=m.find(".s-js-materials-filter-more-link");if(e.length){g.find(".s-js-filtered-view-list").append(e.children())}if(k.length){g.append(k)}Drupal.attachBehaviors(g)},complete:function(){sToggleActiveLoader(c);d.remove()}})})});$(".s-js-materials-filtered-actions:not(.sCourse-processed)",b).addClass("sCourse-processed").each(function(){$(this).find(".action-links-wrapper").sActionLinks({hidden:false})
})}(a))};function sCourseEnableContentReorder(b){var a=sCourseMaterialsDisplayIsWithoutIndex();if(!b.closest("#course-profile-materials").hasClass("materials-admin-view")){return}var c=$("#course-profile-materials-folders").hasClass("planner-view");if(c){if(b.parent().attr("id")=="folder-contents-table"){var d=false}else{var d=".subtree-folder-contents-table>tbody, .planner-right-contents-table>tbody"}}else{var d="#folder-contents-table>tbody, .subtree-folder-contents-table>tbody, .planner-right-contents-table>tbody"}b.sortable({forcePointerForContainers:true,items:"> tr:not(.materials-row-add)",handle:".folder-title, .item-title, .document-body-title, .item-icon, .inline-icon",connectWith:d,cancel:".materials-row-add, .type-empty",delay:500,helper:function(j,f){var g=f.clone(),h=f.find(".folder-subtree");g.find(".folder-subtree").hide();g.find(".s-js-folder-description").hide();if(h.length){g.height(f.height()-h.height())}return g},placeholder:"reorder-target-placeholder",opacity:0.5,expandDelay:500,expand:function(g,f){var h=$(".folder-expander",f);
if(h.length&&!h.hasClass("expanded")){h.click()}},start:function(h,g){sCourseSaveContentTableWeightsTimeout&&clearTimeout(sCourseSaveContentTableWeightsTimeout);$("#folder-contents-table").addClass("sorting");var f=g.placeholder.next(".materials-row-add");if(f.length){g.item.data("sCourseReorderRowAdd",f)}},stop:function(k,o){$("#folder-contents-table").removeClass("sorting");var m=o.item;var l=o.item.parent();var g=o.item.data("sCourseReorderRowAdd");if(g){if(o.item.next(".materials-row-add").length){o.item.before(g)}else{o.item.after(g)}o.item.removeData("sCourseReorderRowAdd")}var f=0;var j=getQueryParams(window.location.search);var h=j.f||0;var n=o.item.parent().closest(".material-row-folder");if(n.length){h=n.attr("id").split("-")[1]}l.children().each(function(){var p=$(this);if(p.hasClass("materials-row-add")){var e=p.attr("id").split("-");e[3]=h;e[4]=f;p.attr("id",e.join("-"))}else{p.attr("display_weight",f);f++}});sCourseSaveContentTableWeights(l,m)},change:function(h,g){if(!a){var j=getQueryParams(window.location.search);
var f=j.f||0;if(f==0&&!g.item.hasClass("material-row-folder")&&$(g.placeholder).closest("table").attr("id")=="folder-contents-table"){$(g.placeholder).hide()}else{$(g.placeholder).show()}}},receive:function(j,h){if($(this).parent().attr("id")=="folder-contents-table"){if(!a){var k=getQueryParams(window.location.search);var f=k.f||0;if(f==0&&!h.item.hasClass("material-row-folder")){h.sender.sortable("cancel")}}}else{h.item.find(".folder-alignment-wrapper").remove();h.item.find(".folder-visibility").remove()}var g=h.item.parent();$(">.type-empty",g).hide();if(h.sender&&h.sender.children().not(".materials-row-add").not(".type-empty").length==0){$(">.type-empty",h.sender).show()}},})}function sCourseMaterialsDetermineDestination(c,a,b){if(location.pathname!=Drupal.settings.basePath+c.path){location.reload()}}function sCourseTopicGotoEditor(c,a,b){location.href=Drupal.settings.basePath+c.js.setting.popups.originalPath;return false}function setupAssignmentPaging(a){$(".gitem-pager").each(function(){var b=$(this);
var d=window.location.pathname.substring(1);var c=d.split("/")[1];$("a",this).unbind("click").click(function(j){j.preventDefault();periodID=b.attr("id");var h=$(this).attr("href").split("page=");h=h[1];var f=$(".pager-count",b).val();gradeItemType=b.hasClass("assessment")?"assessment":"grade-item";b.hide();b.after('<img src="/sites/all/themes/schoology_theme/images/ajax-loader.gif" class="loader" alt="'+Drupal.t("Loading")+'" />');var g="/course/"+c+"/assignment_page/"+periodID+"/"+gradeItemType;if(b.parents(".past-assignments-grading-period").length>0){g+="/past"}$.ajax({url:g+"?page="+h+"&count="+f,dataType:"json",type:"GET",success:function(l,e){var m=b.parents("li:first");$("ul:first",m).empty();var k=$(l.html);$("ul:first",m).append(k);b.siblings(".loader").remove();b.replaceWith(l.pager);setTimeout(function(){setupAssignmentPaging(a)},500);Drupal.attachBehaviors(document)}})})})}function sCourseTrackGenericPostView(b){var e=b.attr("id").split("-").pop();var a=sCommonGetSetting("s_realm_info","csm_realm_id");
if(!a){a=Drupal.settings.s_realm_info.realm_id}var c="/"+Drupal.settings.s_realm_info.realm+"/"+a+"/materials/document/"+e;var d={url:"/stats/manual-tracker/trackPageView",type:"POST",data:{action_url:c}};if(!b.hasClass("embed-cover")){d.success=function(){location.href=b.attr("href")}}$.ajaxSecure(d)}var sCourseSaveContentTableWeightsTimeout=null;function sCourseSaveContentTableWeights(a,c){c.addClass("ui-sortable-item-changed");a.addClass("ui-sortable-changed");sCourseSaveContentTableWeightsTimeout&&clearTimeout(sCourseSaveContentTableWeightsTimeout);sCourseSaveContentTableWeightsTimeout=setTimeout(sCourseSaveContentTableWeightsTimeoutHelper,2000);var b=$("#center-top h2.page-title");if(!$("#folder-reorder-save-loader").length){$("body").append('<div id="folder-reorder-save-loader"><span>'+Drupal.t("Saving...")+"</span></div>")}}function sCourseSaveContentTableWeightsTimeoutHelper(){var e=$("#course-profile-materials .ui-sortable.ui-sortable-changed .ui-sortable-item-changed").removeClass("ui-sortable-item-changed");
var g=$("#course-profile-materials .ui-sortable.ui-sortable-changed").removeClass("ui-sortable-changed");var b=e.attr("id");var d=b.search(/^n-[\d]+$/)===0?b:"";if(!g.length){return}var c=getQueryParams(window.location.search);var a=c.f||0;var f={};g.each(function(){var k=$(this);var m=a;var l=k.closest(".material-row-folder");if(l.length){m=l.attr("id").split("-")[1]}f[m]={};k.children().not(".materials-row-add").not("reorder-target-placeholder").not(".type-empty").each(function(){var n=$(this);f[m][n.attr("id")]=n.attr("display_weight")})});var j=window.location.pathname.substring(1);var h=j.split("/")[1];$.ajaxSecure({url:"/course/"+h+"/materials/reorder",data:{updates:f,root_fid:a,dropped_item_id:d},type:"POST",success:function(){$("#folder-reorder-save-loader").remove()},error:function(){$("#folder-reorder-save-loader").remove()}})}function sCourseMaterialsDisplayIsWithoutIndex(){var a=sCommonGetSetting("s_course","display_mode");return a&&a==sCommonGetSetting("s_course","display_mode_without_index")
}var quickInstallAutoLaunchClicked=false;Drupal.behaviors.sAppLauncher=function(a){Drupal.settings.s_app=Drupal.settings.s_app||{};if(!quickInstallAutoLaunchClicked&&typeof Drupal.settings.s_app!="undefined"){if(Drupal.settings.s_app.auto_launch_quick_install){$(".app-quick-installer-popup").click();quickInstallAutoLaunchClicked=true}}$("#schoology-app-loader:not(.sAppLauncher-processed)",a).addClass("sAppLauncher-processed").each(function(){if(Drupal.settings.s_app.launcher){var g=sAppLauncherGetParams({type:"standard",isImport:false,url:location.href});var f=g.appNid+"-"+g.realm+"-"+g.realmID;if(Drupal.settings.s_app.launcher.hasOwnProperty(f)){var d=$("#content-wrapper");var e=$("#csm-section-toggle");var c=Drupal.settings.s_app.launcher[f];var b=Drupal.theme("sAppContainer",c.type,c.url,c.cookie_required,e.length?e.html():"");d.html(b);sAttachBehaviors(["sAppLauncher"],d)}}$(this).remove()});$("#schoology-app-container:not(.sAppLauncher-processed)",a).addClass("sAppLauncher-processed").each(function(){var b=$(this);
$(window).resize(function(){var d=$(this).height();$("#header, #center-top:visible").each(function(){d-=$(this).outerHeight()});b.height(d)}).trigger("resize");var c=false;$(".primary-activities .clickable").each(function(){$(this).click(function(){if(!c){var d=false;if($.browser.msie&&$.browser.version.charAt(0)==8){document.onfocusout=function(){if(d){$(".activities-dropdown-wrapper").hide();c=false}}}else{$(window).bind("blur.sAppLauncher",function(){if(d){$(".activities-dropdown-wrapper").hide();$(window).unbind("blur.sAppLauncher");c=false}})}b.bind("mouseover",function(){d=true});b.bind("mouseout",function(){d=false})}c=true})});$(".s-js-launch-button",b).bind("click",function(f){f.preventDefault();if($(this).hasClass("disabled")){return}var d=sCommonOpenNewWindow($(this).attr("href"),{name:"schoology-app"});if(d!==false){$(this).addClass("disabled");$(this).prev(".app-launch-message").html(Drupal.t("Your app has been launched in a new window."));d.focus()}});$(".s-js-launch-button",b).trigger("click")
});$("#s-js-tinymce-resources-insert-form-wrapper:not(.sTinymceResourcesInsert-processed)",a).addClass("sTinymceResourcesInsert-processed").each(function(){var f=$("#s-tinymce-resources-insert-form",$(this));var g=parseInt($("#edit-app-nid",f).val());var e=$("#edit-app-type",f).val();var b=$("#edit-realm",f).val();var d=parseInt($("#edit-realm-id",f).val());var c=parseInt($("#edit-folder-id",f).val());var h=parseInt($("#edit-fweight",f).val());var j={};j.type=e;j.isRTE=true;if(e=="resources"){j.url="/resources/apps/"+g+"/run"}else{if(e=="lti"){j.url="/apps/lti/"+g+"/run/"+b+"/"+d+"?f="+c+"&fweight="+h}else{return}}sAppLauncher($("#s-js-resources-app-container",f),j)})};Drupal.theme.prototype.sAppContainer=function(b,d,a,e){var c="";if(a){c+='<div class="cookie-warning">';c+='<p class="app-launch-message">'+Drupal.t("This app must be launched by clicking on its link on the left menu.")+"</p>";c+="</div>";return c}if(b==2){c+='<div id="schoology-app-container" align="center">';c+='<p class="app-launch-message">'+Drupal.t("We attempted to launch your app in a new window, but a popup blocker is preventing it from opening. Please disable popup blockers for this site.")+"</p>";
c+='<a class="link-btn s-js-launch-button" href="'+d+'">'+Drupal.t("Launch App")+"</a>";c+="</div>"}else{if(e){c+='<div id="schoology-csm_toggle" align="left">';c+="<p>"+e+"</p>";c+="</div>"}c+='<iframe id="schoology-app-container" frameborder="0" width="100%" height="800" src="'+d+'" name="schoology-app-container"></iframe>'}return c};function sAppLauncher(b,e){if(!Drupal.settings.s_app.launcher){Drupal.settings.s_app.launcher={}}var d=sAppLauncherGetParams(e);var c=d.appNid+"-"+d.realm+"-"+d.realmID;function a(g){var f=Drupal.theme("sAppContainer",g.type,g.url,g.cookie_required);b.html(f);sAttachBehaviors(["sAppLauncher"],b)}if(Drupal.settings.s_app.launcher.hasOwnProperty(c)){a(Drupal.settings.s_app.launcher[c]);return}sToggleActiveLoader("sAppLauncher",b);$.getJSON(d.settingsURI,function(f){sToggleActiveLoader("sAppLauncher");Drupal.settings.s_app.launcher[c]=f.body;a(Drupal.settings.s_app.launcher[c])})}function sAppLauncherGetParams(b){var f={import_view:b.isImport?1:0};var a="";var j=0;
var k="";var e=0;var g={};function c(n,m){if(n!=""){var n=n.split("&");for(i=0;i<n.length;i++){var l=n[i].split("=");m[l[0]]=l[1]}}}if(b.type=="resources"){var d=b.url.match(/\/([0-9]+)\/run(\?)?(.*)/);j=d[1];k="user";e=Drupal.settings.s_common.user.uid;a+=j+"/"+b.type;c(d[3],f)}else{if(b.type=="standard"||b.type=="lti"){if(b.url.indexOf("/apps/school_apps/")!=-1){var d=b.url.match(/\/apps\/school_apps\/([0-9]+)\/configure(\?)?(.*)/);j=d[1];k="school";e=Drupal.settings.s_common.user.school_nid}else{var d=b.url.match(/\/([0-9]+)\/run\/([a-z]+)\/([0-9]+)(\?)?(.*)/);j=d[1];k=d[2];e=d[3];g=getQueryParams(b.url)}a+=j+"/"+b.type+"/"+k+"/"+e;if(typeof b.isRTE!="undefined"&&b.isRTE==true){a+="&from=rte";if(g&&typeof g.f!="undefined"){a+="&f="+String(g.f)}if(g&&typeof g.fweight!="undefined"){a+="&fweight="+String(g.fweight)}}}}if(a==""){return false}var h=[];if(b.type=="resources"){$.each(f,function(l,m){h.push(l+"="+encodeURIComponent(m))});a+="?"+h.join("&")}a="/iapi/app/launcher/"+a;return{appNid:j,realm:k,realmID:e,settingsURI:a}
}function sAppLauncherClearCache(a){for(var b in Drupal.settings.s_app.launcher){if(b.split("-")[0]==a){delete Drupal.settings.s_app.launcher[b];break}}}Drupal.behaviors.sAppMenu=function(a){$("#menu-s-apps-list .app-link:not(.sAppMenu-processed), .resources-app-list .s-js-app-launch.resources-app-title:not(.sAppMenu-processed)",a).addClass("sAppMenu-processed").each(function(){var c=$(this);var b=c.hasClass("resources-app-title");c.click(function(f){var d,h,g;if(!b){d=c.parents(".app-link-wrapper").attr("id").split("-")[2];h=c.attr("href")}else{d=c.parents(".s-app-resource-app").attr("id").split("-")[1];h=c.attr("href")}g=sCommonGetSetting("s_app","cookie_preload_urls",d);if(g){f.preventDefault();if(b){f.stopImmediatePropagation()}sAppMenuCookiePreloadRun(d,g,function(){if(!b){window.location=h}else{sAppLauncherClearCache(d);sAppMenuCookiePreloadDelete(d);c.trigger("click.s-js-library-ajax-links")}})}})})};function sAppMenuCookiePreloadRun(b,c,a){window.open(c,"cookiepreloader","width=100,height=100,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0");
$.ajax({url:"/apps/"+b+"/cookies_loaded",async:false});setTimeout(a,800)}function sAppMenuCookiePreloadSet(a){Drupal.settings.s_app=Drupal.settings.s_app||{};Drupal.settings.s_app.cookie_preload_urls=Drupal.settings.s_app.cookie_preload_urls||{};for(var b in a){Drupal.settings.s_app.cookie_preload_urls[b]=a[b]}}function sAppMenuCookiePreloadDelete(a){delete Drupal.settings.s_app.cookie_preload_urls[a]}(function(){var Q=jQuery,t,ao,F="mathquill-command-id",k="mathquill-block-id",al=Math.min,z=Math.max;var L=[].slice;function ag(){}function e(P){var ap=L.call(arguments,1);return function(){return P.apply(this,ap)}}function ad(ap,P){if(!P){throw new Error("prayer failed: "+ap)}}var h=(function(aq,ar,av){function ap(P){return typeof P==="object"}function au(P){return typeof P==="function"}function at(aA,aw){if(aw===av){aw=aA;aA=Object}function aB(aD){var aC=this;if(!(aC instanceof aB)){return new aB(arguments)}if(aD&&au(aC.init)){aC.init.apply(aC,aD)}}var az=aB[aq]=new aA();var ay=aA[aq];var ax;
var P=aB.mixin=function(aD){ax={};if(au(aD)){ax=aD.call(aB,az,ay,aB,aA)}else{if(ap(aD)){ax=aD}}if(ap(ax)){for(var aC in ax){if(ar.call(ax,aC)){az[aC]=ax[aC]}}}if(!au(az.init)){az.init=function(){aA.apply(this,arguments)}}return aB};az.constructor=aB;return P(aw)}return at})("prototype",({}).hasOwnProperty);var m=(function(){var P={8:"Backspace",9:"Tab",10:"Enter",13:"Enter",16:"Shift",17:"Control",18:"Alt",20:"CapsLock",27:"Esc",32:"Spacebar",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",45:"Insert",46:"Del",144:"NumLock"};function aq(at){var aw=at.which||at.keyCode;var ar=P[aw];var av;var au=[];if(at.ctrlKey){au.push("Ctrl")}if(at.originalEvent&&at.originalEvent.metaKey){au.push("Meta")}if(at.altKey){au.push("Alt")}if(at.shiftKey){au.push("Shift")}av=ar||String.fromCharCode(aw);if(!au.length&&!ar){return av}au.push(av);return au.join("-")}return function ap(at,aE){var aG=null;var aA=null;if(!aE){aE={}}var aC=aE.text||ag;var ay=aE.key||ag;var aL=aE.paste||ag;
var ax=aE.cut||ag;var aF=Q(at);var aN=Q(aE.container||aF);var az,aH;function au(aO){az=setTimeout(aO);aH=aO}function aJ(){if(az){clearTimeout(az);az=t;aH()}}aN.bind("keydown keypress input keyup focusout paste",aJ);function aI(aO){aJ();aF.val(aO);if(aO){aF[0].select()}}function aK(){var aO=aF[0];if(!("selectionStart" in aO)){return false}return aO.selectionStart!==aO.selectionEnd}function av(aP){var aO=aF.val();aF.val("");if(aO){aP(aO)}}function aD(){ay(aq(aG),aG)}function aM(aO){aG=aO;aA=null;aD()}function aw(aO){if(aG&&aA){aD()}aA=aO;au(function(){if(aK()){return}av(aC)})}function aB(){aG=aA=null}function ar(aO){aF.focus();au(function(){av(aL)})}aN.bind({keydown:aM,keypress:aw,focusout:aB,cut:ax,paste:ar});return{select:aI}}}());var c=h(function(aD,aF,at){function au(aH,aG){if(aH){aH="'"+aH+"'"}else{aH="EOF"}throw"Parse Error: "+aG+" at "+aH}aD.init=function(aG){this._=aG};aD.parse=function(aH){return this.skip(aE)._(aH,aG,au);function aG(aJ,aI){return aI}};aD.or=function(aH){ad("or is passed a parser",aH instanceof at);
var aG=this;return at(function(aL,aK,aJ){return aG._(aL,aK,aI);function aI(aM){return aH._(aL,aK,aJ)}})};aD.then=function(aH){var aG=this;return at(function(aL,aK,aI){return aG._(aL,aJ,aI);function aJ(aO,aM){var aN=(aH instanceof at?aH:aH(aM));ad("a parser is returned",aN instanceof at);return aN._(aO,aK,aI)}})};aD.many=function(){var aG=this;return at(function(aM,aL,aJ){var aI=[];while(aG._(aM,aK,aH)){}return aL(aM,aI);function aK(aO,aN){aM=aO;aI.push(aN);return true}function aH(){return false}})};aD.times=function(aI,aG){if(arguments.length<2){aG=aI}var aH=this;return at(function(aQ,aP,aJ){var aL=[];var aS=true;var aK;for(var aN=0;aN<aI;aN+=1){aS=aH._(aQ,aR,aM);if(!aS){return aJ(aQ,aK)}}for(;aN<aG&&aS;aN+=1){aS=aH._(aQ,aR,aO)}return aP(aQ,aL);function aR(aU,aT){aL.push(aT);aQ=aU;return true}function aM(aU,aT){aK=aT;aQ=aU;return false}function aO(aU,aT){return false}})};aD.result=function(aG){return this.then(av(aG))};aD.atMost=function(aG){return this.times(0,aG)};aD.atLeast=function(aH){var aG=this;
return aG.times(aH).then(function(aI){return aG.many().map(function(aJ){return aI.concat(aJ)})})};aD.map=function(aG){return this.then(function(aH){return av(aG(aH))})};aD.skip=function(aG){return this.then(function(aH){return aG.result(aH)})};var aw=this.string=function(aI){var aG=aI.length;var aH="expected '"+aI+"'";return at(function(aM,aL,aK){var aJ=aM.slice(0,aG);if(aJ===aI){return aL(aM.slice(aG),aJ)}else{return aK(aM,aH)}})};var aB=this.regex=function(aG){ad("regexp parser is anchored",aG.toString().charAt(1)==="^");var aH="expected "+aG;return at(function(aM,aL,aK){var aJ=aG.exec(aM);if(aJ){var aI=aJ[0];return aL(aM.slice(aI.length),aI)}else{return aK(aM,aH)}})};var av=at.succeed=function(aG){return at(function(aI,aH){return aH(aI,aG)})};var ar=at.fail=function(aG){return at(function(aJ,aH,aI){return aI(aJ,aG)})};var aq=at.letter=aB(/^[a-z]/i);var ay=at.letters=aB(/^[a-z]*/i);var aA=at.digit=aB(/^[0-9]/);var ap=at.digits=aB(/^[0-9]*/);var P=at.whitespace=aB(/^\s+/);var az=at.optWhitespace=aB(/^\s*/);
var ax=at.any=at(function(aI,aH,aG){if(!aI){return aG(aI,"expected any character")}return aH(aI.slice(1),aI.charAt(0))});var aC=at.all=at(function(aI,aH,aG){return aH("",aI)});var aE=at.eof=at(function(aI,aH,aG){if(aI){return aG(aI,"expected EOF")}return aH(aI,aI)})});var A=h(function(P){P.prev=0;P.next=0;P.parent=0;P.firstChild=0;P.lastChild=0;P.children=function(){return H(this.firstChild,this.lastChild)};P.eachChild=function(ap){return this.children().each(ap)};P.foldChildren=function(ap,aq){return this.children().fold(ap,aq)};P.adopt=function(aq,ar,ap){H(this,this).adopt(aq,ar,ap);return this};P.disown=function(){H(this,this).disown();return this}});var H=h(function(P){P.first=0;P.last=0;P.init=function(ar,aq){ad("no half-empty fragments",!ar===!aq);if(!ar){return}ad("first node is passed to Fragment",ar instanceof A);ad("last node is passed to Fragment",aq instanceof A);ad("first and last have the same parent",ar.parent===aq.parent);this.first=ar;this.last=aq};function ap(ar,at,aq){ad("a parent is always present",ar);
ad("prev is properly set up",(function(){if(!at){return ar.firstChild===aq}return at.next===aq&&at.parent===ar})());ad("next is properly set up",(function(){if(!aq){return ar.lastChild===at}return aq.prev===at&&aq.parent===ar})())}P.adopt=function(at,av,ar){ap(at,av,ar);var aq=this;aq.disowned=false;var aw=aq.first;if(!aw){return this}var au=aq.last;if(av){}else{at.firstChild=aw}if(ar){ar.prev=au}else{at.lastChild=au}aq.last.next=ar;aq.each(function(ax){ax.prev=av;ax.parent=at;if(av){av.next=ax}av=ax});return aq};P.disown=function(){var aq=this;var au=aq.first;if(!au||aq.disowned){return aq}aq.disowned=true;var at=aq.last;var ar=au.parent;ap(ar,au.prev,au);ap(ar,at,at.next);if(au.prev){au.prev.next=at.next}else{ar.firstChild=at.next}if(at.next){at.next.prev=au.prev}else{ar.lastChild=au.prev}return aq};P.each=function(at){var aq=this;var ar=aq.first;if(!ar){return aq}for(;ar!==aq.last.next;ar=ar.next){if(at.call(aq,ar)===false){break}}return aq};P.fold=function(aq,ar){this.each(function(at){aq=ar.call(this,aq,at)
});return aq}});var j=(function(){var P=0;return function(){return P+=1}})();var E=h(A,function(P){P.init=function(ap){this.id=j();E[this.id]=this};P.toString=function(){return"[MathElement "+this.id+"]"};P.bubble=function(at){var ap=L.call(arguments,1);for(var ar=this;ar;ar=ar.parent){var aq=ar[at]&&ar[at].apply(ar,ap);if(aq===false){break}}return this};P.postOrder=function(ar){var aq=L.call(arguments,1);if(typeof ar==="string"){var ap=ar;ar=function(au){if(ap in au){au[ap].apply(au,arguments)}}}(function at(au){au.eachChild(at);ar(au)})(this)};P.jQ=Q();P.jQadd=function(ap){this.jQ=this.jQ.add(ap)};this.jQize=function(ap){var aq=Q(ap);aq.find("*").andSelf().each(function(){var au=Q(this),ar=au.attr("mathquill-command-id"),at=au.attr("mathquill-block-id");if(ar){E[ar].jQadd(au)}if(at){E[at].jQadd(au)}});return aq};P.finalizeInsert=function(){var ap=this;ap.postOrder("finalizeTree");ap.postOrder("blur");ap.postOrder("respace");if(ap.next.respace){ap.next.respace()}if(ap.prev.respace){ap.prev.respace()
}ap.postOrder("redraw");ap.bubble("redraw")}});var C=h(E,function(P,ap){P.init=function(at,au,aq){var ar=this;ap.init.call(ar);if(!ar.ctrlSeq){ar.ctrlSeq=at}if(au){ar.htmlTemplate=au}if(aq){ar.textTemplate=aq}};P.replaces=function(aq){aq.disown();this.replacedFragment=aq};P.isEmpty=function(){return this.foldChildren(true,function(aq,ar){return aq&&ar.isEmpty()})};P.parser=function(){var ar=T.block;var aq=this;return ar.times(aq.numBlocks()).map(function(au){aq.blocks=au;for(var at=0;at<au.length;at+=1){au[at].adopt(aq,aq.lastChild,0)}return aq})};P.createBefore=function(at){var aq=this;var ar=aq.replacedFragment;aq.createBlocks();E.jQize(aq.html());if(ar){ar.adopt(aq.firstChild,0,0);ar.jQ.appendTo(aq.firstChild.jQ)}at.jQ.before(aq.jQ);at.prev=aq.adopt(at.parent,at.prev,at.next);aq.finalizeInsert(at);aq.placeCursor(at)};P.createBlocks=function(){var ar=this,au=ar.numBlocks(),at=ar.blocks=Array(au);for(var aq=0;aq<au;aq+=1){var av=at[aq]=w();av.adopt(ar,ar.lastChild,0)}};P.respace=ag;P.placeCursor=function(aq){aq.appendTo(this.foldChildren(this.firstChild,function(ar,at){return ar.isEmpty()?ar:at
}))};P.remove=function(){this.disown();this.jQ.remove();this.postOrder(function(aq){delete E[aq.id]});return this};P.numBlocks=function(){var aq=this.htmlTemplate.match(/&\d+/g);return aq?aq.length:0};P.html=function(){var av=this;var ax=av.blocks;var aq=" mathquill-command-id="+av.id;var aw=av.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);ad("no unmatched angle brackets",aw.join("")===this.htmlTemplate);for(var at=0,ar=aw[0];ar;at+=1,ar=aw[at]){if(ar.slice(-2)==="/>"){aw[at]=ar.slice(0,-2)+aq+"/>"}else{if(ar.charAt(0)==="<"){ad("not an unmatched top-level close tag",ar.charAt(1)!=="/");aw[at]=ar.slice(0,-1)+aq+">";var au=1;do{at+=1,ar=aw[at];ad("no missing close tags",ar);if(ar.slice(0,2)==="</"){au-=1}else{if(ar.charAt(0)==="<"&&ar.slice(-2)!=="/>"){au+=1}}}while(au>0)}}}return aw.join("").replace(/>&(\d+)/g,function(az,ay){return" mathquill-block-id="+ax[ay].id+">"+ax[ay].join("html")})};P.latex=function(){return this.foldChildren(this.ctrlSeq,function(aq,ar){return aq+"{"+(ar.latex()||" ")+"}"
})};P.textTemplate=[""];P.text=function(){var aq=0;return this.foldChildren(this.textTemplate[aq],function(at,au){aq+=1;var ar=au.text();if(at&&this.textTemplate[aq]==="("&&ar[0]==="("&&ar.slice(-1)===")"){return at+ar.slice(1,-1)+this.textTemplate[aq]}return at+au.text()+(this.textTemplate[aq]||"")})}});var X=h(C,function(P,ap){P.init=function(ar,aq,at){if(!at){at=ar&&ar.length>1?ar.slice(1):ar}ap.init.call(this,ar,aq,[at])};P.parser=function(){return c.succeed(this)};P.numBlocks=function(){return 0};P.replaces=function(aq){aq.remove()};P.createBlocks=ag;P.latex=function(){return this.ctrlSeq};P.text=function(){return this.textTemplate};P.placeCursor=ag;P.isEmpty=function(){return true}});var w=h(E,function(P){P.join=function(ap){return this.foldChildren("",function(aq,ar){return aq+ar[ap]()})};P.latex=function(){return this.join("latex")};P.text=function(){return this.firstChild===this.lastChild?this.firstChild.text():"("+this.join("text")+")"};P.isEmpty=function(){return this.firstChild===0&&this.lastChild===0
};P.focus=function(){this.jQ.addClass("hasCursor");this.jQ.removeClass("empty");return this};P.blur=function(){this.jQ.removeClass("hasCursor");if(this.isEmpty()){this.jQ.addClass("empty")}return this}});var Z=h(H,function(P,ap){P.init=function(ar,aq){ap.init.call(this,ar,aq||ar);this.jQ=this.fold(Q(),function(at,au){return au.jQ.add(at)})};P.latex=function(){return this.fold("",function(ar,aq){return ar+aq.latex()})};P.remove=function(){this.jQ.remove();this.each(function(aq){aq.postOrder(function(ar){delete E[ar.id]})});return this.disown()}});function af(av,ay,ax,aq){var ar=av.contents().detach();if(!ax){av.addClass("mathquill-rendered-math")}ay.jQ=av.attr(k,ay.id);ay.revert=function(){av.empty().unbind(".mathquill").removeClass("mathquill-rendered-math mathquill-editable mathquill-textbox").append(ar)};var aB=ay.cursor=J(ay);ay.renderLatex(ar.text());var aC=ay.textarea=Q('<span class="textarea"><textarea></textarea></span>'),aA=aC.children();var au;ay.selectionChanged=function(){if(au===t){au=setTimeout(P)
}l(av[0])};function P(){au=t;var aD=aB.selection?"$"+aB.selection.latex()+"$":"";aw.select(aD)}av.bind("selectstart.mathquill",function(aD){if(aD.target!==aA[0]){aD.preventDefault()}aD.stopPropagation()});var at,ap=aB.blink;av.bind("mousedown.mathquill",function(aE){function aD(aH){aB.seek(Q(aH.target),aH.pageX,aH.pageY);if(aB.prev!==at.prev||aB.parent!==at.parent){aB.selectFrom(at)}return false}function aG(aH){delete aH.target;return aD(aH)}function aF(aH){at=t;aB.blink=ap;if(!aB.selection){if(aq){aB.show()}else{aC.detach()}}av.unbind("mousemove",aD);Q(aH.target.ownerDocument).unbind("mousemove",aG).unbind("mouseup",aF)}setTimeout(function(){aA.focus()});aB.blink=ag;aB.seek(Q(aE.target),aE.pageX,aE.pageY);at={parent:aB.parent,prev:aB.prev,next:aB.next};if(!aq){av.prepend(aC)}av.mousemove(aD);Q(aE.target.ownerDocument).mousemove(aG).mouseup(aF);return false});if(!aq){var aw=m(aA,{container:av});av.bind("cut paste",false).bind("copy",P).prepend('<span class="selectable">$'+ay.latex()+"$</span>");
aA.blur(function(){aB.clearSelection();setTimeout(az)});function az(){aC.detach()}return}var aw=m(aA,{container:av,key:function(aE,aD){aB.parent.bubble("onKey",aE,aD)},text:function(aD){aB.parent.bubble("onText",aD)},cut:function(aD){if(aB.selection){setTimeout(function(){aB.prepareEdit();aB.parent.bubble("redraw")})}aD.stopPropagation()},paste:function(aD){if(aD.slice(0,1)==="$"&&aD.slice(-1)==="$"){aD=aD.slice(1,-1)}else{aD="\\text{"+aD+"}"}aB.writeLatex(aD).show()}});av.prepend(aC);av.addClass("mathquill-editable");if(ax){av.addClass("mathquill-textbox")}aA.focus(function(aD){if(!aB.parent){aB.appendTo(ay)}aB.parent.jQ.addClass("hasCursor");if(aB.selection){aB.selection.jQ.removeClass("blur");setTimeout(ay.selectionChanged)}else{aB.show()}aD.stopPropagation()}).blur(function(aD){aB.hide().parent.blur();if(aB.selection){aB.selection.jQ.addClass("blur")}aD.stopPropagation()});av.bind("focus.mathquill blur.mathquill",function(aD){aA.trigger(aD)}).blur()}var n=h(w,function(P,ap){P.latex=function(){return ap.latex.call(this).replace(/(\\[a-z]+) (?![a-z])/ig,"$1")
};P.text=function(){return this.foldChildren("",function(aq,ar){return aq+ar.text()})};P.renderLatex=function(aq){var ar=this.jQ;ar.children().slice(1).remove();this.firstChild=this.lastChild=0;this.cursor.appendTo(this).writeLatex(aq)};P.onKey=function(aq,at){switch(aq){case"Ctrl-Shift-Backspace":case"Ctrl-Backspace":while(this.cursor.prev||this.cursor.selection){this.cursor.backspace()}break;case"Shift-Backspace":case"Backspace":this.cursor.backspace();break;case"Esc":case"Tab":case"Spacebar":var ar=this.cursor.parent;if(ar===this.cursor.root){if(aq==="Spacebar"){at.preventDefault()}return}this.cursor.prepareMove();if(ar.next){this.cursor.prependTo(ar.next)}else{this.cursor.insertAfter(ar.parent)}break;case"Shift-Tab":case"Shift-Esc":case"Shift-Spacebar":var ar=this.cursor.parent;if(ar===this.cursor.root){if(aq==="Shift-Spacebar"){at.preventDefault()}return}this.cursor.prepareMove();if(ar.prev){this.cursor.appendTo(ar.prev)}else{this.cursor.insertBefore(ar.parent)}break;case"Enter":break;
case"End":this.cursor.prepareMove().appendTo(this.cursor.parent);break;case"Ctrl-End":this.cursor.prepareMove().appendTo(this);break;case"Shift-End":while(this.cursor.next){this.cursor.selectRight()}break;case"Ctrl-Shift-End":while(this.cursor.next||this.cursor.parent!==this){this.cursor.selectRight()}break;case"Home":this.cursor.prepareMove().prependTo(this.cursor.parent);break;case"Ctrl-Home":this.cursor.prepareMove().prependTo(this);break;case"Shift-Home":while(this.cursor.prev){this.cursor.selectLeft()}break;case"Ctrl-Shift-Home":while(this.cursor.prev||this.cursor.parent!==this){this.cursor.selectLeft()}break;case"Left":this.cursor.moveLeft();break;case"Shift-Left":this.cursor.selectLeft();break;case"Ctrl-Left":break;case"Right":this.cursor.moveRight();break;case"Shift-Right":this.cursor.selectRight();break;case"Ctrl-Right":break;case"Up":this.cursor.moveUp();break;case"Down":this.cursor.moveDown();break;case"Shift-Up":if(this.cursor.prev){while(this.cursor.prev){this.cursor.selectLeft()
}}else{this.cursor.selectLeft()}case"Shift-Down":if(this.cursor.next){while(this.cursor.next){this.cursor.selectRight()}}else{this.cursor.selectRight()}case"Ctrl-Up":break;case"Ctrl-Down":break;case"Ctrl-Shift-Del":case"Ctrl-Del":while(this.cursor.next||this.cursor.selection){this.cursor.deleteForward()}break;case"Shift-Del":case"Del":this.cursor.deleteForward();break;case"Meta-A":case"Ctrl-A":if(this!==this.cursor.root){return}this.cursor.prepareMove().appendTo(this);while(this.cursor.prev){this.cursor.selectLeft()}break;default:return false}at.preventDefault();return false};P.onText=function(aq){this.cursor.write(aq);return false}});var ai=h(C,function(P,ap){P.init=function(aq){ap.init.call(this,"$");this.cursor=aq};P.htmlTemplate='<span class="mathquill-rendered-math">&0</span>';P.createBlocks=function(){this.firstChild=this.lastChild=n();this.blocks=[this.firstChild];this.firstChild.parent=this;var aq=this.firstChild.cursor=this.cursor;this.firstChild.onText=function(ar){if(ar!=="$"||aq.parent!==this){aq.write(ar)
}else{if(this.isEmpty()){aq.insertAfter(this.parent).backspace().insertNew(ab("\\$","$")).show()}else{if(!aq.next){aq.insertAfter(this.parent)}else{if(!aq.prev){aq.insertBefore(this.parent)}else{aq.write(ar)}}}}return false}};P.latex=function(){return"$"+this.firstChild.latex()+"$"}});var V=h(w,function(P){P.renderLatex=function(at){var aD=this;var aB=aD.cursor;aD.jQ.children().slice(1).remove();aD.firstChild=aD.lastChild=0;aB.show().appendTo(aD);var ay=c.regex;var aw=c.string;var aC=c.eof;var aA=c.all;var ax=aw("$").then(T).skip(aw("$").or(aC)).map(function(aG){var aF=ai(aB);aF.createBlocks();var aE=aF.firstChild;aG.children().adopt(aE,0,0);return aF});var az=aw("\\$").result("$");var aq=az.or(ay(/^[^$]/)).map(ab);var ap=ax.or(aq).many();var ar=ap.skip(aC).or(aA.result(false)).parse(at);if(ar){for(var au=0;au<ar.length;au+=1){ar[au].adopt(aD,aD.lastChild,0)}var av=aD.join("html");E.jQize(av).appendTo(aD.jQ);this.finalizeInsert()}};P.onKey=n.prototype.onKey;P.onText=function(ap){this.cursor.prepareEdit();
if(ap==="$"){this.cursor.insertNew(ai(this.cursor))}else{this.cursor.insertNew(ab(ap))}return false}});var y={},K={};var R,l=ag,ah=document.createElement("div"),an=ah.style,G={transform:1,WebkitTransform:1,MozTransform:1,OTransform:1,msTransform:1},a;for(var x in G){if(x in an){a=x;break}}if(a){R=function(ap,P,aq){ap.css(a,"scale("+P+","+aq+")")}}else{if("filter" in an){l=function(P){P.className=P.className};R=function(ar,P,au){P/=(1+(au-1)/2);ar.css("fontSize",au+"em");if(!ar.hasClass("matrixed-container")){ar.addClass("matrixed-container").wrapInner('<span class="matrixed"></span>')}var at=ar.children().css("filter","progid:DXImageTransform.Microsoft.Matrix(M11="+P+",SizingMethod='auto expand')");function aq(){ar.css("marginRight",(at.width()-1)*(P-1)/P+"px")}aq();var ap=setInterval(aq);Q(window).load(function(){clearTimeout(ap);aq()})}}else{R=function(ap,P,aq){ap.css("fontSize",aq+"em")}}}var I=h(C,function(P,ap){P.init=function(at,ar,aq){ap.init.call(this,at,"<"+ar+" "+aq+">&0</"+ar+">")
}});K.mathrm=e(I,"\\mathrm","span",'class="roman font"');K.mathit=e(I,"\\mathit","i",'class="font"');K.mathbf=e(I,"\\mathbf","b",'class="font"');K.mathsf=e(I,"\\mathsf","span",'class="sans-serif font"');K.mathtt=e(I,"\\mathtt","span",'class="monospace font"');K.underline=e(I,"\\underline","span",'class="non-leaf underline"');K.overline=K.bar=e(I,"\\overline","span",'class="non-leaf overline"');K.overleftrightarrow=K.bar=e(I,"\\overleftrightarrow","span",'class="non-leaf overleftrightarrow"');K.overrightarrow=K.bar=e(I,"\\overrightarrow","span",'class="non-leaf overrightarrow"');var am=h(C,function(P,ap){P.init=function(ar,aq,at){ap.init.call(this,ar,"<"+aq+' class="non-leaf">&0</'+aq+">",[at])};P.finalizeTree=function(){ad("SupSub is only _ and ^",this.ctrlSeq==="^"||this.ctrlSeq==="_");if(this.ctrlSeq==="_"){this.down=this.firstChild;this.firstChild.up=aq}else{this.up=this.firstChild;this.firstChild.down=aq}function aq(au){var ar=this.parent,at=au;do{if(at.next){au.insertBefore(ar);return false
}at=at.parent.parent}while(at!==ar);au.insertAfter(ar);return false}};P.latex=function(){var aq=this.firstChild.latex();if(aq.length===1){return this.ctrlSeq+aq}else{return this.ctrlSeq+"{"+(aq||" ")+"}"}};P.redraw=function(){if(this.prev){this.prev.respace()}if(!(this.prev instanceof am)){this.respace();if(this.next&&!(this.next instanceof am)){this.next.respace()}}};P.respace=function(){if(this.prev.ctrlSeq==="\\int "||(this.prev instanceof am&&this.prev.ctrlSeq!=this.ctrlSeq&&this.prev.prev&&this.prev.prev.ctrlSeq==="\\int ")){if(!this.limit){this.limit=true;this.jQ.addClass("limit")}}else{if(this.limit){this.limit=false;this.jQ.removeClass("limit")}}this.respaced=this.prev instanceof am&&this.prev.ctrlSeq!=this.ctrlSeq&&!this.prev.respaced;if(this.respaced){var ar=+this.jQ.css("fontSize").slice(0,-2),aq=this.prev.jQ.outerWidth(),at=this.jQ.outerWidth();this.jQ.css({left:(this.limit&&this.ctrlSeq==="_"?-0.25:0)-aq/ar+"em",marginRight:0.1-al(at,aq)/ar+"em"})}else{if(this.limit&&this.ctrlSeq==="_"){this.jQ.css({left:"-.25em",marginRight:""})
}else{this.jQ.css({left:"",marginRight:""})}}if(this.next instanceof am){this.next.respace()}return this}});K.subscript=K._=e(am,"_","sub","_");K.superscript=K.supscript=K["^"]=e(am,"^","sup","**");var aa=K.frac=K.dfrac=K.cfrac=K.fraction=h(C,function(P,ap){P.ctrlSeq="\\frac";P.htmlTemplate='<span class="fraction non-leaf"><span class="numerator">&0</span><span class="denominator">&1</span><span style="display:inline-block;width:0">&nbsp;</span></span>';P.textTemplate=["(","/",")"];P.finalizeTree=function(){this.up=this.lastChild.up=this.firstChild;this.down=this.firstChild.down=this.lastChild}});var g=K.over=y["/"]=h(aa,function(P,ap){P.createBefore=function(ar){if(!this.replacedFragment){var aq=ar.prev;while(aq&&!(aq instanceof aj||aq instanceof ac||aq instanceof v)){aq=aq.prev}if(aq instanceof v&&aq.next instanceof am){aq=aq.next;if(aq.next instanceof am&&aq.next.ctrlSeq!=aq.ctrlSeq){aq=aq.next}}if(aq!==ar.prev){this.replaces(Z(aq.next||ar.parent.firstChild,ar.prev));ar.prev=aq}}ap.createBefore.call(this,ar)
}});var u=K.sqrt=K["√"]=h(C,function(P,ap){P.ctrlSeq="\\sqrt";P.htmlTemplate='<span class="non-leaf"><span class="scaled sqrt-prefix">&radic;</span><span class="non-leaf sqrt-stem">&0</span></span>';P.textTemplate=["sqrt(",")"];P.parser=function(){return T.optBlock.then(function(aq){return T.block.map(function(at){var ar=ak();ar.blocks=[aq,at];aq.adopt(ar,0,0);at.adopt(ar,aq,0);return ar})}).or(ap.parser.call(this))};P.redraw=function(){var aq=this.lastChild.jQ;R(aq.prev(),1,aq.innerHeight()/+aq.css("fontSize").slice(0,-2)-0.1)}});var ak=K.nthroot=h(u,function(P,ap){P.htmlTemplate='<sup class="nthroot non-leaf">&0</sup><span class="scaled"><span class="sqrt-prefix scaled">&radic;</span><span class="sqrt-stem non-leaf">&1</span></span>';P.textTemplate=["sqrt[","](",")"];P.latex=function(){return"\\sqrt["+this.firstChild.latex()+"]{"+this.lastChild.latex()+"}"}});var B=h(C,function(P,ap){P.init=function(ar,au,at,aq){ap.init.call(this,"\\left"+at,'<span class="non-leaf"><span class="scaled paren">'+ar+'</span><span class="non-leaf">&0</span><span class="scaled paren">'+au+"</span></span>",[ar,au]);
this.end="\\right"+aq};P.jQadd=function(){ap.jQadd.apply(this,arguments);var aq=this.jQ;this.bracketjQs=aq.children(":first").add(aq.children(":last"))};P.latex=function(){return this.ctrlSeq+this.firstChild.latex()+this.end};P.redraw=function(){var ar=this.firstChild.jQ;var aq=ar.outerHeight()/+ar.css("fontSize").slice(0,-2);R(this.bracketjQs,al(1+0.2*(aq-1),1.2),1.05*aq)}});K.left=h(C,function(P){P.parser=function(){var aq=c.regex;var ap=c.string;var aq=c.regex;var ar=c.succeed;var au=T.block;var at=c.optWhitespace;return at.then(aq(/^(?:[([|]|\\\{)/)).then(function(av){if(av.charAt(0)==="\\"){av=av.slice(1)}var aw=y[av]();return T.map(function(ax){aw.blocks=[ax];ax.adopt(aw,0,0)}).then(ap("\\right")).skip(at).then(aq(/^(?:[\])|]|\\\})/)).then(function(ax){if(ax.slice(-1)!==aw.end.slice(-1)){return c.fail("open doesn't match close")}return ar(aw)})})}});K.right=h(C,function(P){P.parser=function(){return c.fail("unmatched \\right")}});K.lbrace=y["{"]=e(B,"{","}","\\{","\\}");K.langle=K.lang=e(B,"&lang;","&rang;","\\langle ","\\rangle ");
var W=h(B,function(P,ap){P.createBefore=function(aq){if(!aq.next&&aq.parent.parent&&aq.parent.parent.end===this.end&&!this.replacedFragment){aq.insertAfter(aq.parent.parent)}else{ap.createBefore.call(this,aq)}};P.placeCursor=function(aq){this.firstChild.blur();aq.insertAfter(this)}});K.rbrace=y["}"]=e(W,"{","}","\\{","\\}");K.rangle=K.rang=e(W,"&lang;","&rang;","\\langle ","\\rangle ");var r=function(P,ap){P.init=function(aq,ar){ap.init.call(this,aq,ar,aq,ar)}};var M=h(B,r);K.lparen=y["("]=e(M,"(",")");K.lbrack=K.lbracket=y["["]=e(M,"[","]");var O=h(W,r);K.rparen=y[")"]=e(O,"(",")");K.rbrack=K.rbracket=y["]"]=e(O,"[","]");var b=K.lpipe=K.rpipe=y["|"]=h(M,function(P,ap){P.init=function(){ap.init.call(this,"|","|")};P.createBefore=W.prototype.createBefore});var ac=y.$=K.text=K.textnormal=K.textrm=K.textup=K.textmd=h(C,function(P,ap){P.ctrlSeq="\\text";P.htmlTemplate='<span class="text">&0</span>';P.replaces=function(aq){if(aq instanceof Z){this.replacedText=aq.remove().jQ.text()}else{if(typeof aq==="string"){this.replacedText=aq
}}};P.textTemplate=['"','"'];P.parser=function(){var aq=c.string;var ar=c.regex;var at=c.optWhitespace;return at.then(aq("{")).then(ar(/^[^}]*/)).skip(aq("}")).map(function(ay){var aw=ac();aw.createBlocks();var ax=aw.firstChild;for(var au=0;au<ay.length;au+=1){var av=ab(ay.charAt(au));av.adopt(ax,ax.lastChild,0)}return aw})};P.createBlocks=function(){this.firstChild=this.lastChild=q();this.blocks=[this.firstChild];this.firstChild.parent=this};P.finalizeInsert=function(){this.firstChild.blur=function(){delete this.blur;return this};ap.finalizeInsert.call(this)};P.createBefore=function(ar){ap.createBefore.call(this,this.cursor=ar);if(this.replacedText){for(var aq=0;aq<this.replacedText.length;aq+=1){this.write(this.replacedText.charAt(aq))}}};P.write=function(aq){this.cursor.insertNew(ab(aq))};P.onKey=function(aq,ar){if(!this.cursor.selection&&((aq==="Backspace"&&!this.cursor.prev)||(aq==="Del"&&!this.cursor.next))){if(this.isEmpty()){this.cursor.insertAfter(this)}return false}};P.onText=function(ar){this.cursor.prepareEdit();
if(ar!=="$"){this.write(ar)}else{if(this.isEmpty()){this.cursor.insertAfter(this).backspace().insertNew(ab("\\$","$"))}else{if(!this.cursor.next){this.cursor.insertAfter(this)}else{if(!this.cursor.prev){this.cursor.insertBefore(this)}else{var aq=ac(Z(this.cursor.next,this.firstChild.lastChild));aq.placeCursor=function(at){this.prev=0;delete this.placeCursor;this.placeCursor(at)};aq.firstChild.focus=function(){return this};this.cursor.insertAfter(this).insertNew(aq);aq.prev=this;this.cursor.insertBefore(aq);delete aq.firstChild.focus}}}}return false}});var q=h(w,function(P,ap){P.blur=function(){this.jQ.removeClass("hasCursor");if(this.isEmpty()){var aq=this.parent,ar=aq.cursor;if(ar.parent===this){this.jQ.addClass("empty")}else{ar.hide();aq.remove();if(ar.next===aq){ar.next=aq.next}else{if(ar.prev===aq){ar.prev=aq.prev}}ar.show().parent.bubble("redraw")}}return this};P.focus=function(){ap.focus.call(this);var ar=this.parent;if(ar.next.ctrlSeq===ar.ctrlSeq){var au=this,at=ar.cursor,aq=ar.next.firstChild;
aq.eachChild(function(av){av.parent=au;av.jQ.appendTo(au.jQ)});if(this.lastChild){this.lastChild.next=aq.firstChild}else{this.firstChild=aq.firstChild}aq.firstChild.prev=this.lastChild;this.lastChild=aq.lastChild;aq.parent.remove();if(at.prev){at.insertAfter(at.prev)}else{at.prependTo(this)}at.parent.bubble("redraw")}else{if(ar.prev.ctrlSeq===ar.ctrlSeq){var at=ar.cursor;if(at.prev){ar.prev.firstChild.focus()}else{at.appendTo(ar.prev.firstChild)}}}return this}});function o(aq,ap,P){return h(ac,{ctrlSeq:aq,htmlTemplate:"<"+ap+" "+P+">&0</"+ap+">"})}K.em=K.italic=K.italics=K.emph=K.textit=K.textsl=o("\\textit","i",'class="text"');K.strong=K.bold=K.textbf=o("\\textbf","b",'class="text"');K.sf=K.textsf=o("\\textsf","span",'class="sans-serif text"');K.tt=K.texttt=o("\\texttt","span",'class="monospace text"');K.textsc=o("\\textsc","span",'style="font-variant:small-caps" class="text"');K.uppercase=o("\\uppercase","span",'style="text-transform:uppercase" class="text"');K.lowercase=o("\\lowercase","span",'style="text-transform:lowercase" class="text"');
var Y=y["\\"]=h(C,function(P,ap){P.ctrlSeq="\\";P.replaces=function(aq){this._replacedFragment=aq.disown();this.isEmpty=function(){return false}};P.htmlTemplate='<span class="latex-command-input non-leaf">\\<span>&0</span></span>';P.textTemplate=["\\"];P.createBlocks=function(){ap.createBlocks.call(this);this.firstChild.focus=function(){this.parent.jQ.addClass("hasCursor");if(this.isEmpty()){this.parent.jQ.removeClass("empty")}return this};this.firstChild.blur=function(){this.parent.jQ.removeClass("hasCursor");if(this.isEmpty()){this.parent.jQ.addClass("empty")}return this}};P.createBefore=function(ar){ap.createBefore.call(this,ar);this.cursor=ar.appendTo(this.firstChild);if(this._replacedFragment){var aq=this.jQ[0];this.jQ=this._replacedFragment.jQ.addClass("blur").bind("mousedown mousemove",function(at){Q(at.target=aq).trigger(at);return false}).insertBefore(this.jQ).add(this.jQ)}};P.latex=function(){return"\\"+this.firstChild.latex()+" "};P.onKey=function(aq,ar){if(aq==="Tab"||aq==="Enter"||aq==="Spacebar"){this.renderCommand();
ar.preventDefault();return false}};P.onText=function(aq){if(aq.match(/[a-z]/i)){this.cursor.prepareEdit();this.cursor.insertNew(ab(aq));return false}this.renderCommand();if(aq==="\\"&&this.firstChild.isEmpty()){return false}};P.renderCommand=function(){this.jQ=this.jQ.last();this.remove();if(this.next){this.cursor.insertBefore(this.next)}else{this.cursor.appendTo(this.parent)}var ar=this.firstChild.latex(),aq;if(!ar){ar="backslash"}this.cursor.insertCmd(ar,this._replacedFragment)}});var N=K.binom=K.binomial=h(C,function(P,ap){P.ctrlSeq="\\binom";P.htmlTemplate='<span class="paren scaled">(</span><span class="non-leaf"><span class="array non-leaf"><span>&0</span><span>&1</span></span></span><span class="paren scaled">)</span>';P.textTemplate=["choose(",",",")"];P.redraw=function(){var at=this.jQ.eq(1);var aq=at.outerHeight()/+at.css("fontSize").slice(0,-2);var ar=this.jQ.filter(".paren");R(ar,al(1+0.2*(aq-1),1.2),1.05*aq)}});var p=K.choose=h(N,function(P){P.createBefore=g.prototype.createBefore
});var D=K.vector=h(C,function(P,ap){P.ctrlSeq="\\vector";P.htmlTemplate='<span class="array"><span>&0</span></span>';P.latex=function(){return"\\begin{matrix}"+this.foldChildren([],function(aq,ar){aq.push(ar.latex());return aq}).join("\\\\")+"\\end{matrix}"};P.text=function(){return"["+this.foldChildren([],function(aq,ar){aq.push(ar.text());return aq}).join()+"]"};P.createBefore=function(aq){ap.createBefore.call(this,this.cursor=aq)};P.onKey=function(aq,at){var ar=this.cursor.parent;if(ar.parent===this){if(aq==="Enter"){var au=w();au.parent=this;au.jQ=Q("<span></span>").attr(k,au.id).insertAfter(ar.jQ);if(ar.next){ar.next.prev=au}else{this.lastChild=au}au.next=ar.next;ar.next=au;au.prev=ar;this.bubble("redraw").cursor.appendTo(au);at.preventDefault();return false}else{if(aq==="Tab"&&!ar.next){if(ar.isEmpty()){if(ar.prev){this.cursor.insertAfter(this);delete ar.prev.next;this.lastChild=ar.prev;ar.jQ.remove();this.bubble("redraw");at.preventDefault();return false}else{return}}var au=w();
au.parent=this;au.jQ=Q("<span></span>").attr(k,au.id).appendTo(this.jQ);this.lastChild=au;ar.next=au;au.prev=ar;this.bubble("redraw").cursor.appendTo(au);at.preventDefault();return false}else{if(at.which===8){if(ar.isEmpty()){if(ar.prev){this.cursor.appendTo(ar.prev);ar.prev.next=ar.next}else{this.cursor.insertBefore(this);this.firstChild=ar.next}if(ar.next){ar.next.prev=ar.prev}else{this.lastChild=ar.prev}ar.jQ.remove();if(this.isEmpty()){this.cursor.deleteForward()}else{this.bubble("redraw")}at.preventDefault();return false}else{if(!this.cursor.prev){at.preventDefault();return false}}}}}}}});K.editable=h(ai,function(P,ap){P.init=function(){C.prototype.init.call(this,"\\editable")};P.jQadd=function(){var aq=this;ap.jQadd.apply(aq,arguments);var ar=aq.firstChild.disown();var at=aq.jQ.children().detach();aq.firstChild=aq.lastChild=n();aq.blocks=[aq.firstChild];aq.firstChild.parent=aq;af(aq.jQ,aq.firstChild,false,true);aq.cursor=aq.firstChild.cursor;ar.children().adopt(aq.firstChild,0,0);
at.appendTo(aq.firstChild.jQ);aq.firstChild.cursor.appendTo(aq.firstChild)};P.latex=function(){return this.firstChild.latex()};P.text=function(){return this.firstChild.text()}});K.f=e(X,"f",'<var class="florin">&fnof;</var><span style="display:inline-block;width:0">&nbsp;</span>');var s=h(X,function(P,ap){P.init=function(ar,aq){ap.init.call(this,ar,"<var>"+(aq||ar)+"</var>")};P.text=function(){var aq=this.ctrlSeq;if(this.prev&&!(this.prev instanceof s)&&!(this.prev instanceof aj)){aq="*"+aq}if(this.next&&!(this.next instanceof aj)&&!(this.next.ctrlSeq==="^")){aq+="*"}return aq}});var ab=h(X,function(P,ap){P.init=function(ar,aq){ap.init.call(this,ar,"<span>"+(aq||ar)+"</span>")}});y[" "]=e(ab,"\\:"," ");K.prime=y["'"]=e(ab,"'","&prime;");var f=h(X,function(P,ap){P.init=function(ar,aq){ap.init.call(this,ar,'<span class="nonSymbola">'+(aq||ar)+"</span>")}});K["@"]=f;K["&"]=e(f,"\\&","&amp;");K["%"]=e(f,"\\%","%");K.alpha=K.beta=K.gamma=K.delta=K.zeta=K.eta=K.theta=K.iota=K.kappa=K.mu=K.nu=K.xi=K.rho=K.sigma=K.tau=K.chi=K.psi=K.omega=h(s,function(P,ap){P.init=function(aq){ap.init.call(this,"\\"+aq+" ","&"+aq+";")
}});K.phi=e(s,"\\phi ","&#981;");K.phiv=K.varphi=e(s,"\\varphi ","&phi;");K.epsilon=e(s,"\\epsilon ","&#1013;");K.epsiv=K.varepsilon=e(s,"\\varepsilon ","&epsilon;");K.piv=K.varpi=e(s,"\\varpi ","&piv;");K.sigmaf=K.sigmav=K.varsigma=e(s,"\\varsigma ","&sigmaf;");K.thetav=K.vartheta=K.thetasym=e(s,"\\vartheta ","&thetasym;");K.upsilon=K.upsi=e(s,"\\upsilon ","&upsilon;");K.gammad=K.Gammad=K.digamma=e(s,"\\digamma ","&#989;");K.kappav=K.varkappa=e(s,"\\varkappa ","&#1008;");K.rhov=K.varrho=e(s,"\\varrho ","&#1009;");K.pi=K["π"]=e(f,"\\pi ","&pi;");K.lambda=e(f,"\\lambda ","&lambda;");K.Upsilon=K.Upsi=K.upsih=K.Upsih=e(X,"\\Upsilon ",'<var style="font-family: serif">&upsih;</var>');K.Gamma=K.Delta=K.Theta=K.Lambda=K.Xi=K.Pi=K.Sigma=K.Phi=K.Psi=K.Omega=K.forall=h(ab,function(P,ap){P.init=function(aq){ap.init.call(this,"\\"+aq+" ","&"+aq+";")}});var ae=h(C,function(P){P.init=function(ap){this.latex=ap};P.createBefore=function(ap){ap.writeLatex(this.latex)};P.parser=function(){var ap=T.parse(this.latex).children();
return c.succeed(ap)}});K["¹"]=e(ae,"^1");K["²"]=e(ae,"^2");K["³"]=e(ae,"^3");K["¼"]=e(ae,"\\frac14");K["½"]=e(ae,"\\frac12");K["¾"]=e(ae,"\\frac34");var aj=h(X,function(P,ap){P.init=function(ar,aq,at){ap.init.call(this,ar,'<span class="binary-operator">'+aq+"</span>",at)}});var d=h(aj,function(P){P.init=ab.prototype.init;P.respace=function(){if(!this.prev){this.jQ[0].className=""}else{if(this.prev instanceof aj&&this.next&&!(this.next instanceof aj)){this.jQ[0].className="unary-operator"}else{this.jQ[0].className="binary-operator"}}return this}});K["+"]=e(d,"+","+");K["–"]=K["-"]=e(d,"-","&minus;");K["±"]=K.pm=K.plusmn=K.plusminus=e(d,"\\pm ","&plusmn;");K.mp=K.mnplus=K.minusplus=e(d,"\\mp ","&#8723;");y["*"]=K.sdot=K.cdot=e(aj,"\\cdot ","&middot;");K["="]=e(aj,"=","=");K["<"]=e(aj,"<","&lt;");K[">"]=e(aj,">","&gt;");K.notin=K.sim=K.cong=K.equiv=K.oplus=K.otimes=h(aj,function(P,ap){P.init=function(aq){ap.init.call(this,"\\"+aq+" ","&"+aq+";")}});K.times=e(aj,"\\times ","&times;","[x]");
K["÷"]=K.div=K.divide=K.divides=e(aj,"\\div ","&divide;","[/]");K["≠"]=K.ne=K.neq=e(aj,"\\ne ","&ne;");K.ast=K.star=K.loast=K.lowast=e(aj,"\\ast ","&lowast;");K.therefor=K.therefore=e(aj,"\\therefore ","&there4;");K.cuz=K.because=e(aj,"\\because ","&#8757;");K.prop=K.propto=e(aj,"\\propto ","&prop;");K["≈"]=K.asymp=K.approx=e(aj,"\\approx ","&asymp;");K.napprox=e(aj,"\\not\\approx ","&#8777;");K.lt=e(aj,"<","&lt;");K.gt=e(aj,">","&gt;");K["≤"]=K.le=K.leq=e(aj,"\\le ","&le;");K["≥"]=K.ge=K.geq=e(aj,"\\ge ","&ge;");K.isin=K["in"]=e(aj,"\\in ","&isin;");K.ni=K.contains=e(aj,"\\ni ","&ni;");K.notni=K.niton=K.notcontains=K.doesnotcontain=e(aj,"\\not\\ni ","&#8716;");K.sub=K.subset=e(aj,"\\subset ","&sub;");K.sup=K.supset=K.superset=e(aj,"\\supset ","&sup;");K.nsub=K.notsub=K.nsubset=K.notsubset=e(aj,"\\not\\subset ","&#8836;");K.nsup=K.notsup=K.nsupset=K.notsupset=K.nsuperset=K.notsuperset=e(aj,"\\not\\supset ","&#8837;");K.sube=K.subeq=K.subsete=K.subseteq=e(aj,"\\subseteq ","&sube;");K.supe=K.supeq=K.supsete=K.supseteq=K.supersete=K.superseteq=e(aj,"\\supseteq ","&supe;");
K.nsube=K.nsubeq=K.notsube=K.notsubeq=K.nsubsete=K.nsubseteq=K.notsubsete=K.notsubseteq=e(aj,"\\not\\subseteq ","&#8840;");K.nsupe=K.nsupeq=K.notsupe=K.notsupeq=K.nsupsete=K.nsupseteq=K.notsupsete=K.notsupseteq=K.nsupersete=K.nsuperseteq=K.notsupersete=K.notsuperseteq=e(aj,"\\not\\supseteq ","&#8841;");var v=h(X,function(P,ap){P.init=function(ar,aq){ap.init.call(this,ar,"<big>"+aq+"</big>")}});K["∑"]=K.sum=K.summation=e(v,"\\sum ","&sum;");K["∏"]=K.prod=K.product=e(v,"\\prod ","&prod;");K.coprod=K.coproduct=e(v,"\\coprod ","&#8720;");K["∫"]=K["int"]=K.integral=e(v,"\\int ","&int;");K.naturals=K.Naturals=e(ab,"\\mathbb{N}","&#8469;");K.primes=K.Primes=K.projective=K.Projective=K.probability=K.Probability=e(ab,"\\mathbb{P}","&#8473;");K.integers=K.Integers=e(ab,"\\mathbb{Z}","&#8484;");K.rationals=K.Rationals=e(ab,"\\mathbb{Q}","&#8474;");K.reals=K.Reals=e(ab,"\\mathbb{R}","&#8477;");K.complex=K.Complex=K.complexes=K.Complexes=K.complexplane=K.Complexplane=K.ComplexPlane=e(ab,"\\mathbb{C}","&#8450;");
K.Hamiltonian=K.quaternions=K.Quaternions=e(ab,"\\mathbb{H}","&#8461;");K.quad=K.emsp=e(ab,"\\quad ","    ");K.qquad=e(ab,"\\qquad ","        ");K.diamond=e(ab,"\\diamond ","&#9671;");K.bigtriangleup=e(ab,"\\bigtriangleup ","&#9651;");K.ominus=e(ab,"\\ominus ","&#8854;");K.uplus=e(ab,"\\uplus ","&#8846;");K.bigtriangledown=e(ab,"\\bigtriangledown ","&#9661;");K.sqcap=e(ab,"\\sqcap ","&#8851;");K.lhd=e(ab,"\\lhd ","&#8882;");K.triangleleft=e(ab,"\\triangleleft ","&#8882;");K.sqcup=e(ab,"\\sqcup ","&#8852;");K.rhd=e(ab,"\\rhd ","&#8883;");K.triangleright=e(ab,"\\triangleright ","&#8883;");K.odot=e(ab,"\\odot ","&#8857;");K.bigcirc=e(ab,"\\bigcirc ","&#9711;");K.dagger=e(ab,"\\dagger ","&#0134;");K.ddagger=e(ab,"\\ddagger ","&#135;");K.wr=e(ab,"\\wr ","&#8768;");K.amalg=e(ab,"\\amalg ","&#8720;");K.models=e(ab,"\\models ","&#8872;");K.prec=e(ab,"\\prec ","&#8826;");K.succ=e(ab,"\\succ ","&#8827;");K.preceq=e(ab,"\\preceq ","&#8828;");K.succeq=e(ab,"\\succeq ","&#8829;");K.simeq=e(ab,"\\simeq ","&#8771;");
K.mid=e(ab,"\\mid ","&#8739;");K.ll=e(ab,"\\ll ","&#8810;");K.gg=e(ab,"\\gg ","&#8811;");K.parallel=e(ab,"\\parallel ","&#8741;");K.nparallel=e(ab,"\\nparallel ","&#8742;");K.bowtie=e(ab,"\\bowtie ","&#8904;");K.sqsubset=e(ab,"\\sqsubset ","&#8847;");K.sqsupset=e(ab,"\\sqsupset ","&#8848;");K.smile=e(ab,"\\smile ","&#8995;");K.sqsubseteq=e(ab,"\\sqsubseteq ","&#8849;");K.sqsupseteq=e(ab,"\\sqsupseteq ","&#8850;");K.doteq=e(ab,"\\doteq ","&#8784;");K.frown=e(ab,"\\frown ","&#8994;");K.vdash=e(ab,"\\vdash ","&#8870;");K.dashv=e(ab,"\\dashv ","&#8867;");K.longleftarrow=e(ab,"\\longleftarrow ","&#8592;");K.longrightarrow=e(ab,"\\longrightarrow ","&#8594;");K.Longleftarrow=e(ab,"\\Longleftarrow ","&#8656;");K.Longrightarrow=e(ab,"\\Longrightarrow ","&#8658;");K.longleftrightarrow=e(ab,"\\longleftrightarrow ","&#8596;");K.updownarrow=e(ab,"\\updownarrow ","&#8597;");K.Longleftrightarrow=e(ab,"\\Longleftrightarrow ","&#8660;");K.Updownarrow=e(ab,"\\Updownarrow ","&#8661;");K.mapsto=e(ab,"\\mapsto ","&#8614;");
K.nearrow=e(ab,"\\nearrow ","&#8599;");K.hookleftarrow=e(ab,"\\hookleftarrow ","&#8617;");K.hookrightarrow=e(ab,"\\hookrightarrow ","&#8618;");K.searrow=e(ab,"\\searrow ","&#8600;");K.leftharpoonup=e(ab,"\\leftharpoonup ","&#8636;");K.rightharpoonup=e(ab,"\\rightharpoonup ","&#8640;");K.swarrow=e(ab,"\\swarrow ","&#8601;");K.leftharpoondown=e(ab,"\\leftharpoondown ","&#8637;");K.rightharpoondown=e(ab,"\\rightharpoondown ","&#8641;");K.nwarrow=e(ab,"\\nwarrow ","&#8598;");K.rightleftarrows=e(ab,"\\rightleftarrows ","&#8644;");K.ldots=e(ab,"\\ldots ","&#8230;");K.cdots=e(ab,"\\cdots ","&#8943;");K.vdots=e(ab,"\\vdots ","&#8942;");K.ddots=e(ab,"\\ddots ","&#8944;");K.surd=e(ab,"\\surd ","&#8730;");K.triangle=e(ab,"\\triangle ","&#9653;");K.ell=e(ab,"\\ell ","&#8467;");K.top=e(ab,"\\top ","&#8868;");K.flat=e(ab,"\\flat ","&#9837;");K.natural=e(ab,"\\natural ","&#9838;");K.sharp=e(ab,"\\sharp ","&#9839;");K.wp=e(ab,"\\wp ","&#8472;");K.bot=e(ab,"\\bot ","&#8869;");K.clubsuit=e(ab,"\\clubsuit ","&#9827;");
K.diamondsuit=e(ab,"\\diamondsuit ","&#9826;");K.heartsuit=e(ab,"\\heartsuit ","&#9825;");K.spadesuit=e(ab,"\\spadesuit ","&#9824;");K.oint=e(ab,"\\oint ","&#8750;");K.bigcap=e(ab,"\\bigcap ","&#8745;");K.bigcup=e(ab,"\\bigcup ","&#8746;");K.bigsqcup=e(ab,"\\bigsqcup ","&#8852;");K.bigvee=e(ab,"\\bigvee ","&#8744;");K.bigwedge=e(ab,"\\bigwedge ","&#8743;");K.bigodot=e(ab,"\\bigodot ","&#8857;");K.bigotimes=e(ab,"\\bigotimes ","&#8855;");K.bigoplus=e(ab,"\\bigoplus ","&#8853;");K.biguplus=e(ab,"\\biguplus ","&#8846;");K.lfloor=e(ab,"\\lfloor ","&#8970;");K.rfloor=e(ab,"\\rfloor ","&#8971;");K.lceil=e(ab,"\\lceil ","&#8968;");K.rceil=e(ab,"\\rceil ","&#8969;");K.slash=e(ab,"\\slash ","&#47;");K.opencurlybrace=e(ab,"\\opencurlybrace ","&#123;");K.closecurlybrace=e(ab,"\\closecurlybrace ","&#125;");K.caret=e(ab,"\\caret ","^");K.underscore=e(ab,"\\underscore ","_");K.backslash=e(ab,"\\backslash ","\\");K.vert=e(ab,"|");K.perp=K.perpendicular=e(ab,"\\perp ","&perp;");K.nabla=K.del=e(ab,"\\nabla ","&nabla;");
K.hbar=e(ab,"\\hbar ","&#8463;");K.AA=K.Angstrom=K.angstrom=e(ab,"\\text\\AA ","&#8491;");K.ring=K.circ=K.circle=e(ab,"\\circ ","&#8728;");K.bull=K.bullet=e(ab,"\\bullet ","&bull;");K.setminus=K.smallsetminus=e(ab,"\\setminus ","&#8726;");K.not=K["¬"]=K.neg=e(ab,"\\neg ","&not;");K["…"]=K.dots=K.ellip=K.hellip=K.ellipsis=K.hellipsis=e(ab,"\\dots ","&hellip;");K.converges=K.darr=K.dnarr=K.dnarrow=K.downarrow=e(ab,"\\downarrow ","&darr;");K.dArr=K.dnArr=K.dnArrow=K.Downarrow=e(ab,"\\Downarrow ","&dArr;");K.diverges=K.uarr=K.uparrow=e(ab,"\\uparrow ","&uarr;");K.uArr=K.Uparrow=e(ab,"\\Uparrow ","&uArr;");K.to=e(aj,"\\to ","&rarr;");K.rarr=K.rightarrow=e(ab,"\\rightarrow ","&rarr;");K.implies=e(aj,"\\Rightarrow ","&rArr;");K.rArr=K.Rightarrow=e(ab,"\\Rightarrow ","&rArr;");K.gets=e(aj,"\\gets ","&larr;");K.larr=K.leftarrow=e(ab,"\\leftarrow ","&larr;");K.impliedby=e(aj,"\\Leftarrow ","&lArr;");K.lArr=K.Leftarrow=e(ab,"\\Leftarrow ","&lArr;");K.harr=K.lrarr=K.leftrightarrow=e(ab,"\\leftrightarrow ","&harr;");
K.iff=e(aj,"\\Leftrightarrow ","&hArr;");K.hArr=K.lrArr=K.Leftrightarrow=e(ab,"\\Leftrightarrow ","&hArr;");K.Re=K.Real=K.real=e(ab,"\\Re ","&real;");K.Im=K.imag=K.image=K.imagin=K.imaginary=K.Imaginary=e(ab,"\\Im ","&image;");K.part=K.partial=e(ab,"\\partial ","&part;");K.inf=K.infin=K.infty=K.infinity=e(ab,"\\infty ","&infin;");K.alef=K.alefsym=K.aleph=K.alephsym=e(ab,"\\aleph ","&alefsym;");K.xist=K.xists=K.exist=K.exists=e(ab,"\\exists ","&exist;");K.nexists=e(ab,"\\nexists","&#8708;");K.and=K.land=K.wedge=e(ab,"\\wedge ","&and;");K.or=K.lor=K.vee=e(ab,"\\vee ","&or;");K.empty=K.emptyset=K.oslash=K.Oslash=K.nothing=K.varnothing=e(aj,"\\varnothing ","&empty;");K.cup=K.union=e(aj,"\\cup ","&cup;");K.cap=K.intersect=K.intersection=e(aj,"\\cap ","&cap;");K.deg=K.degree=e(ab,"^\\circ ","&deg;");K.ang=K.angle=e(ab,"\\angle ","&ang;");K.mang=K.measuredangle=e(ab,"\\measuredangle ","&#8737;");var U=h(X,function(P,ap){P.init=function(aq){ap.init.call(this,"\\"+aq+" ","<span>"+aq+"</span>")};
P.respace=function(){this.jQ[0].className=(this.next instanceof am||this.next instanceof B)?"":"non-italicized-function"}});K.ln=K.lg=K.log=K.span=K.proj=K.det=K.dim=K.min=K.max=K.mod=K.lcm=K.gcd=K.gcf=K.hcf=K.lim=U;(function(){var ap=["sin","cos","tan","sec","cosec","csc","cotan","cot"];for(var P in ap){K[ap[P]]=K[ap[P]+"h"]=K["a"+ap[P]]=K["arc"+ap[P]]=K["a"+ap[P]+"h"]=K["arc"+ap[P]+"h"]=U}}());var T=(function(){function aE(aH){var aI=w();aH.adopt(aI,0,0);return aI}function ax(aJ){var aI=aJ[0]||w();for(var aH=1;aH<aJ.length;aH+=1){aJ[aH].children().adopt(aI,aI.lastChild,0)}return aI}var P=c.string;var ar=c.regex;var aG=c.letter;var ay=c.any;var aD=c.optWhitespace;var aF=c.succeed;var aw=c.fail;var az=aG.map(s);var aA=ar(/^[^${}\\_^]/).map(ab);var ap=ar(/^[^\\]/).or(P("\\").then(ar(/^[a-z]+/i).or(ar(/^\s+/).result(" ")).or(ay))).then(function(aI){var aH=K[aI];if(aH){return aH(aI).parser()}else{return aw("unknown command: \\"+aI)}});var at=ap.or(az).or(aA);var av=P("{").then(function(){return aC
}).skip(P("}"));var au=aD.then(av.or(at.map(aE)));var aC=au.many().map(ax).skip(aD);var aB=P("[").then(au.then(function(aH){return aH.join("latex")!=="]"?aF(aH):aw()}).many().map(ax).skip(aD)).skip(P("]"));var aq=aC;aq.block=au;aq.optBlock=aB;return aq})();var J=h(function(ap){ap.init=function(at){this.parent=this.root=at;var au=this.jQ=this._jQ=Q('<span class="cursor">&zwj;</span>');this.blink=function(){au.toggleClass("blink")};this.upDownCache={}};ap.prev=0;ap.next=0;ap.parent=0;ap.show=function(){this.jQ=this._jQ.removeClass("blink");if("intervalId" in this){clearInterval(this.intervalId)}else{if(this.next){if(this.selection&&this.selection.first.prev===this.prev){this.jQ.insertBefore(this.selection.jQ)}else{this.jQ.insertBefore(this.next.jQ.first())}}else{this.jQ.appendTo(this.parent.jQ)}this.parent.focus()}this.intervalId=setInterval(this.blink,500);return this};ap.hide=function(){if("intervalId" in this){clearInterval(this.intervalId)}delete this.intervalId;this.jQ.detach();this.jQ=Q();
return this};ap.insertAt=function(au,av,at){var aw=this.parent;this.parent=au;this.prev=av;this.next=at;aw.blur()};ap.insertBefore=function(at){this.insertAt(at.parent,at.prev,at);this.parent.jQ.addClass("hasCursor");this.jQ.insertBefore(at.jQ.first());return this};ap.insertAfter=function(at){this.insertAt(at.parent,at,at.next);this.parent.jQ.addClass("hasCursor");this.jQ.insertAfter(at.jQ.last());return this};ap.prependTo=function(at){this.insertAt(at,0,at.firstChild);if(at.textarea){this.jQ.insertAfter(at.textarea)}else{this.jQ.prependTo(at.jQ)}at.focus();return this};ap.appendTo=function(at){this.insertAt(at,at.lastChild,0);this.jQ.appendTo(at.jQ);at.focus();return this};ap.hopLeft=function(){this.jQ.insertBefore(this.prev.jQ.first());this.next=this.prev;this.prev=this.prev.prev;return this};ap.hopRight=function(){this.jQ.insertAfter(this.next.jQ.last());this.prev=this.next;this.next=this.next.next;return this};ap.moveLeftWithin=function(at){if(this.prev){if(this.prev.lastChild){this.appendTo(this.prev.lastChild)
}else{this.hopLeft()}}else{if(this.parent===at){return}if(this.parent.prev){this.appendTo(this.parent.prev)}else{this.insertBefore(this.parent.parent)}}};ap.moveRightWithin=function(at){if(this.next){if(this.next.firstChild){this.prependTo(this.next.firstChild)}else{this.hopRight()}}else{if(this.parent===at){return}if(this.parent.next){this.prependTo(this.parent.next)}else{this.insertAfter(this.parent.parent)}}};ap.moveLeft=function(){aq(this);if(this.selection){this.insertBefore(this.selection.first).clearSelection()}else{this.moveLeftWithin(this.root)}return this.show()};ap.moveRight=function(){aq(this);if(this.selection){this.insertAfter(this.selection.last).clearSelection()}else{this.moveRightWithin(this.root)}return this.show()};ap.moveUp=function(){return P(this,"up")};ap.moveDown=function(){return P(this,"down")};function P(at,au){if(at.next[au]){at.prependTo(at.next[au])}else{if(at.prev[au]){at.appendTo(at.prev[au])}else{var ax=at.parent;do{var ay=ax[au];if(ay){if(typeof ay==="function"){ay=ax[au](at)
}if(ay===false||ay instanceof w){at.upDownCache[ax.id]={parent:at.parent,prev:at.prev,next:at.next};if(ay instanceof w){var aw=at.upDownCache[ay.id];if(aw){if(aw.next){at.insertBefore(aw.next)}else{at.appendTo(aw.parent)}}else{var av=ar(at).left;at.appendTo(ay);at.seekHoriz(av,ay)}}break}}ax=ax.parent.parent}while(ax)}}return at.clearSelection().show()}ap.seek=function(aw,au,at){aq(this);var av,ay,ax=this.clearSelection().show();if(aw.hasClass("empty")){ax.prependTo(E[aw.attr(k)]);return ax}av=E[aw.attr(F)];if(av instanceof X){if(aw.outerWidth()>2*(au-aw.offset().left)){ax.insertBefore(av)}else{ax.insertAfter(av)}return ax}if(!av){ay=E[aw.attr(k)];if(!ay){aw=aw.parent();av=E[aw.attr(F)];if(!av){ay=E[aw.attr(k)];if(!ay){ay=ax.root}}}}if(av){ax.insertAfter(av)}else{ax.appendTo(ay)}return ax.seekHoriz(au,ax.root)};ap.seekHoriz=function(au,ax){var aw=this;var av=ar(aw).left-au;var at;do{aw.moveLeftWithin(ax);at=av;av=ar(aw).left-au}while(av>0&&(aw.prev||aw.parent!==ax));if(-av>at){aw.moveRightWithin(ax)
}return aw};function ar(at){var au=at.jQ.removeClass("cursor").offset();at.jQ.addClass("cursor");return au}ap.writeLatex=function(aw){var au=this;aq(au);au.show().deleteSelection();var av=c.all;var at=c.eof;var ax=T.skip(at).or(av.result(false)).parse(aw);if(ax){ax.children().adopt(au.parent,au.prev,au.next);E.jQize(ax.join("html")).insertBefore(au.jQ);au.prev=ax.lastChild;ax.finalizeInsert();au.parent.bubble("redraw")}return this.hide()};ap.write=function(at){aq(this);return this.show().insertCh(at)};ap.insertCh=function(at){var au;if(at.match(/^[a-eg-zA-Z]$/)){au=s(at)}else{if(au=y[at]||K[at]){au=au(at)}else{au=ab(at)}}if(this.selection){this.prev=this.selection.first.prev;this.next=this.selection.last.next;au.replaces(this.selection);delete this.selection}return this.insertNew(au)};ap.insertNew=function(at){at.createBefore(this);return this};ap.insertCmd=function(at,av){var au=K[at];if(au){au=au(at);if(av){au.replaces(av)}this.insertNew(au)}else{au=ac();au.replaces(at);au.firstChild.focus=function(){delete this.focus;
return this};this.insertNew(au).insertAfter(au);if(av){av.remove()}}return this};ap.unwrapGramp=function(){var au=this.parent.parent;var at=au.parent;var av=au.next;var ax=this;var aw=au.prev;au.disown().eachChild(function(ay){if(ay.isEmpty()){return}ay.children().adopt(at,aw,av).each(function(az){az.jQ.insertBefore(au.jQ.first())});aw=ay.lastChild});if(!this.next){if(this.prev){this.next=this.prev.next}else{while(!this.next){this.parent=this.parent.next;if(this.parent){this.next=this.parent.firstChild}else{this.next=au.next;this.parent=at;break}}}}if(this.next){this.insertBefore(this.next)}else{this.appendTo(at)}au.jQ.remove();if(au.prev){au.prev.respace()}if(au.next){au.next.respace()}};ap.backspace=function(){aq(this);this.show();if(this.deleteSelection()){}else{if(this.prev){if(this.prev.isEmpty()){this.prev=this.prev.remove().prev}else{this.selectLeft()}}else{if(this.parent!==this.root){if(this.parent.parent.isEmpty()){return this.insertAfter(this.parent.parent).backspace()}else{this.unwrapGramp()
}}}}if(this.prev){this.prev.respace()}if(this.next){this.next.respace()}this.parent.bubble("redraw");return this};ap.deleteForward=function(){aq(this);this.show();if(this.deleteSelection()){}else{if(this.next){if(this.next.isEmpty()){this.next=this.next.remove().next}else{this.selectRight()}}else{if(this.parent!==this.root){if(this.parent.parent.isEmpty()){return this.insertBefore(this.parent.parent).deleteForward()}else{this.unwrapGramp()}}}}if(this.prev){this.prev.respace()}if(this.next){this.next.respace()}this.parent.bubble("redraw");return this};ap.selectFrom=function(ax){var aB=this,av=ax;loopThroughAncestors:while(true){for(var ay=this;ay!==aB.parent.parent;ay=ay.parent.parent){if(ay.parent===av.parent){au=ay;az=av;break loopThroughAncestors}}for(var aA=ax;aA!==av.parent.parent;aA=aA.parent.parent){if(aB.parent===aA.parent){au=aB;az=aA;break loopThroughAncestors}}if(aB.parent.parent){aB=aB.parent.parent}if(av.parent.parent){av=av.parent.parent}}var au,az,at;if(au.next!==az){for(var aw=au;
aw;aw=aw.next){if(aw===az.prev){at=true;break}}if(!at){at=az;az=au;au=at}}this.hide().selection=S(au.prev.next||au.parent.firstChild,az.next.prev||az.parent.lastChild);this.insertAfter(az.next.prev||az.parent.lastChild);this.root.selectionChanged()};ap.selectLeft=function(){aq(this);if(this.selection){if(this.selection.first===this.next){if(this.prev){this.hopLeft().selection.extendLeft()}else{if(this.parent!==this.root){this.insertBefore(this.parent.parent).selection.levelUp()}}}else{this.hopLeft();if(this.selection.first===this.selection.last){this.clearSelection().show();return}this.selection.retractLeft()}}else{if(this.prev){this.hopLeft()}else{if(this.parent!==this.root){this.insertBefore(this.parent.parent)}else{return}}this.hide().selection=S(this.next)}this.root.selectionChanged()};ap.selectRight=function(){aq(this);if(this.selection){if(this.selection.last===this.prev){if(this.next){this.hopRight().selection.extendRight()}else{if(this.parent!==this.root){this.insertAfter(this.parent.parent).selection.levelUp()
}}}else{this.hopRight();if(this.selection.first===this.selection.last){this.clearSelection().show();return}this.selection.retractRight()}}else{if(this.next){this.hopRight()}else{if(this.parent!==this.root){this.insertAfter(this.parent.parent)}else{return}}this.hide().selection=S(this.prev)}this.root.selectionChanged()};function aq(at){at.upDownCache={}}ap.prepareMove=function(){aq(this);return this.show().clearSelection()};ap.prepareEdit=function(){aq(this);return this.show().deleteSelection()};ap.clearSelection=function(){if(this.selection){this.selection.clear();delete this.selection;this.root.selectionChanged()}return this};ap.deleteSelection=function(){if(!this.selection){return false}this.prev=this.selection.first.prev;this.next=this.selection.last.next;this.selection.remove();this.root.selectionChanged();return delete this.selection}});var S=h(Z,function(P,ap){P.init=function(){var aq=this;ap.init.apply(aq,arguments);aq.jQwrap(aq.jQ)};P.jQwrap=function(aq){this.jQ=aq.wrapAll('<span class="selection"></span>').parent()
};P.adopt=function(){this.jQ.replaceWith(this.jQ=this.jQ.children());return ap.adopt.apply(this,arguments)};P.clear=function(){this.jQ.replaceWith(this.jQ.children());return this};P.levelUp=function(){var ar=this,aq=ar.first=ar.last=ar.last.parent.parent;ar.clear().jQwrap(aq.jQ);return ar};P.extendLeft=function(){this.first=this.first.prev;this.first.jQ.prependTo(this.jQ)};P.extendRight=function(){this.last=this.last.next;this.last.jQ.appendTo(this.jQ)};P.retractRight=function(){this.first.jQ.insertBefore(this.jQ);this.first=this.first.next};P.retractLeft=function(){this.last.jQ.insertAfter(this.jQ);this.last=this.last.prev}});Q.fn.mathquill=function(au,at){switch(au){case"redraw":return this.each(function(){var ax=Q(this).attr(k),ay=ax&&E[ax];if(ay){(function aw(az){az.eachChild(aw);if(az.redraw){az.redraw()}}(ay))}});case"revert":return this.each(function(){var aw=Q(this).attr(k),ax=aw&&E[aw];if(ax&&ax.revert){ax.revert()}});case"latex":if(arguments.length>1){return this.each(function(){var aw=Q(this).attr(k),ax=aw&&E[aw];
if(ax){ax.renderLatex(at)}})}var ap=Q(this).attr(k),av=ap&&E[ap];return av&&av.latex();case"text":var ap=Q(this).attr(k),av=ap&&E[ap];return av&&av.text();case"html":return this.html().replace(/ ?hasCursor|hasCursor /,"").replace(/ class=(""|(?= |>))/g,"").replace(/<span class="?cursor( blink)?"?><\/span>/i,"").replace(/<span class="?textarea"?><textarea><\/textarea><\/span>/i,"");case"write":if(arguments.length>1){return this.each(function(){var aw=Q(this).attr(k),ay=aw&&E[aw],ax=ay&&ay.cursor;if(ax){ax.writeLatex(at).parent.blur()}})}case"cmd":if(arguments.length>1){return this.each(function(){var aw=Q(this).attr(k),az=aw&&E[aw],ay=az&&az.cursor;if(ay){ay.show();if(/^\\[a-z]+$/i.test(at)){var ax=ay.selection;if(ax){ay.prev=ax.first.prev;ay.next=ax.last.next;delete ay.selection}ay.insertCmd(at.slice(1),ax)}else{ay.insertCh(at)}ay.hide().parent.blur()}})}default:var P=au==="textbox",aq=P||au==="editable",ar=P?V:n;return this.each(function(){af(Q(this),ar(),P,aq)})}};Q(function(){Q(".mathquill-editable:not(.mathquill-rendered-math)").mathquill("editable");
Q(".mathquill-textbox:not(.mathquill-rendered-math)").mathquill("textbox");Q(".mathquill-embedded-latex").mathquill()})}());Drupal.behaviors.sTinymceMathquill=function(b){$(".s-formula-editable:not(.sTinymceMathquill-processed)",b).addClass("sTinymceMathquill-processed").each(function(){sMathquill.initMathquill(this)});var a=Popups.activePopup();if(!a||!$("#"+a.id).hasClass("tinymce-mathquill-formula-popup")){return}var c=false;$(".submit-btn",b).click(function(h){h.preventDefault();var f=tinyMCE.activeEditor.execCommand("sContentGetRealmFromUrl");var g=sMathquill.save();if(g&&g.length&&!c){var d=Base64.encode(g);c=true;$.ajax({url:"/tinymceinsertlatex",type:"POST",dataType:"json",data:{save_formula:1,realm:f[0],realm_id:f[1],formula:g},success:function(l,e,m){c=false;if(l.error){alert(l.error)}else{var j=$(document).data("s_content_saved_formula_image");if(j){$(j).remove();tinyMCE.activeEditor.execCommand("sContentSaveLastNode")}$(document).data("s_content_saved_formula_image",null);Popups.close();
var k='<img src="'+l.content_path+'" formula="'+d+'" class="mathquill-formula" />';tinyMCE.activeEditor.execCommand("sContentInsert",k,{use_native_insert:true})}}})}})};if(typeof sMathquill=="undefined"){sMathquill=(function(){var b={};b.editors=[];b.activeEditor=null;b.config={};b.menuItemList={};_newMarkup=function(c){return{type:"markup",html:c.html}};_newCommandButton=function(c){var d=typeof c.cmd=="object"?c.cmd.join(""):c.cmd;return{type:"button",extraClass:"s-mq-btn s-mq-icon",label:d,tooltip:d.replace("\\",""),fn:function(e){e.event.preventDefault();if(typeof c.cmd=="object"){$.each(c.cmd,function(f,g){e.editor.mathquill("cmd",g)})}else{e.editor.mathquill("cmd",c.cmd)}e.editor.trigger("focus")}}};_newTextButton=function(c){return{type:"button",extraClass:"s-mq-btn s-mq-icon",label:c.text,tooltip:c.text,fn:function(d){d.event.preventDefault();d.editor.mathquill("write",c.text);d.editor.trigger("focus")}}};_newMenuToggleButton=function(c){var d="s-mq-"+c.key.replace(/_/g,"-").toLowerCase();
return{type:"button",extraClass:"s-mq-btn s-mq-menu-toggle",label:c.label,tooltip:c.label,fn:function(g){var j=g.event,f=g.editor;j.preventDefault();var k=$(this);if(k.hasClass("active")){k.removeClass("active");f.siblings(".s-mq-submenu."+d).addClass("hidden")}else{k.addClass("active").siblings(".s-mq-menu-toggle").removeClass("active");var h=f.siblings(".s-mq-submenu");h.not("."+d).addClass("hidden");h.filter("."+d).removeClass("hidden")}b.resize();f.trigger("focus")}}};_newDefaultButton=function(c){var d={type:"button",label:c.label,extraClass:"s-mq-btn"};if(typeof c.fn=="function"){d.fn=c.fn}return d};b.initMathquill=function(d,f){var c=null;if(typeof f=="undefined"){var f={}}var g={editable:true,autoHeight:false};f=$.extend(g,f);var e=$(d);if(f.editable){e.index=b.editors.length;e.menuBars=[];e.hooks={};e.opts=f;_execAllHooks("onBeforeEditorCreate",[e]);e.mathquill("editable");e.initialHeight=e.innerHeight();b.activeEditor=e;e.find("textarea").bind("focus",function(){b.activeEditor=e
});if(typeof b.config.menu_bars!="undefined"){$.each(b.config.menu_bars,function(j,h){h.name=j;b.addMenuBar(h)});this.resize()}b.editors.push(e);_execAllHooks("onEditorCreate",[e])}else{e.mathquill()}return e};b.addMenuBar=function(f){var c=b.activeEditor,d=[];if(!c){return}if(typeof f=="undefined"){var f={}}var g={submenu:false,multiline:false};f=$.extend(g,f);if(typeof f.menu_items=="object"){f.menu_items=f.menu_items.join(",")}if(typeof f.menu_items=="string"){$.each(f.menu_items.split(","),function(h,j){if(new_item=b.getMenuItem(j)){d.push(new_item)}})}var e=$("<div/>").addClass("s-mq-menu-bar");if(typeof f.name=="string"){e.addClass("s-mq-menu-"+f.name.replace(/_/g,"-").toLowerCase())}if(typeof f.submenu!="undefined"&&f.submenu){e.addClass("s-mq-submenu").addClass("hidden")}if(typeof f.multiline!="undefined"&&f.multiline){e.addClass("s-mq-menu-multiline")}if(d.length){$.each(d,function(j,k){var h=null;switch(k.type){case"button":h=b.addButtonToMenuBar(e,k);break;case"markup":e.append(k.html);
break}if(!f.submenu&&h){h.addClass("s-mq-menu-item")}})}if(typeof f.extraClass=="string"){e.addClass(f.extraClass)}e.insertBefore(c);c.menuBars.push(e);return e};b.addButtonToMenuBar=function(d,g){var f=null,c=b.activeEditor;if(typeof d=="object"){if(d.hasClass("s-mq-menu-bar")){f=d}}else{if(typeof d=="number"){if(c&&typeof c.menuBars[d]=="object"){f=c.menuBars[d]}}}if(!f){return null}var h={label:"",extraClass:"",size:20,fn:function(){}};g=$.extend(h,g);var j=$("<span/>").bind("click",function(k){g.fn.apply(this,[{editor:c,event:k}])});btnLabel=$("<span/>").addClass("s-mq-label").appendTo(j);if(g.label.length){btnLabel.text(g.label)}if(g.tooltip.length){j.attr("title",g.tooltip)}if(g.extraClass.length){j.addClass(g.extraClass)}j.addClass("s-mq-size"+g.size);if(j.hasClass("s-mq-embed")){var e=$("<span/>").text(btnLabel.text()).mathquill("editable").mathquill("html");btnLabel.html(e).addClass("mathquill-rendered-math")}else{btnLabel.html(btnLabel.text())}j.appendTo(f);if(typeof g.onAdd=="function"){g.onAdd.apply(b,[j])
}return j};b.getMenuItem=function(d){var e=null,c=null;if(typeof this.menuItemList[d]=="undefined"){if(d.length){c={key:d,cmd:"\\"+d}}}else{c=this.menuItemList[d]}if(c){c.key=d;if(typeof c.html!="undefined"){e=_newMarkup(c)}else{if(typeof c.cmd!="undefined"){e=_newCommandButton(c)}else{if(typeof c.text=="string"){e=_newTextButton(c)}else{if(typeof c.menu_toggle!="undefined"){e=_newMenuToggleButton(c)}else{e=_newDefaultButton(c)}}}}if(typeof e=="object"&&e){if(typeof e.extraClass=="undefined"){e.extraClass=""}e.extraClass+=" s-mq-"+c.key.replace(/_/g,"-").toLowerCase();if(typeof c.compile_label!="boolean"||c.compile_label){e.extraClass+=" s-mq-embed"}if(typeof c.extraClass=="string"){e.extraClass+=" "+c.extraClass}if(typeof c.tooltip!="undefined"){e.tooltip=c.tooltip}else{if(typeof e.tooltip=="undefined"){e.tooltip=typeof e.label!="undefined"?e.label:d}}if(typeof c.label!="undefined"){e.label=c.label}}}return e};b.resize=function(){var d=b.activeEditor;if(d&&typeof d.initialHeight!="undefined"&&typeof d.opts.autoHeight!="undefined"&&d.opts.autoHeight){var c=d.initialHeight;
if(d.menuBars.length){$.each(d.menuBars,function(e,f){if(f.is(":visible")){c-=f.outerHeight()}});d.height(c)}}};b.exec=function(){var c;if(c=this.activeEditor){var d=Array.prototype.slice.call(arguments);return c.mathquill.apply(c,d)}return null};b.write=function(c){return b.exec("write",c)};b.cmd=function(c){return b.exec("cmd",c)};b.reset=function(){return b.exec("revert")};b.getLatex=function(){return b.exec("latex")};b.getHTML=function(){return b.exec("html")};b.save=function(){var c={latex:b.getLatex()};_execAllHooks("onSave",[b.activeEditor,c]);return c.latex};var a={};_addHook=function(d,e,c){if(typeof a[d]=="undefined"){a[d]={}}if(typeof a[d][e]=="undefined"){a[d][e]=[c]}else{a[d][e].push(c)}};_execHooks=function(e,f,d){if(typeof a[e]=="undefined"){return}if(typeof a[e][f]=="undefined"){return}var c=a[e][f];if(typeof d=="undefined"){var d=[]}$.each(c,function(g,h){h.apply(b,d)})};_execGlobalHooks=function(d,c){_execHooks("global",d,c)};_execEditorHooks=function(e,d){var c=b.activeEditor;
if(c){_execHooks("editor_"+c.index,e,d)}};_execAllHooks=function(d,c){$.each(a,function(f,e){_execHooks(f,d,c)})};b.addGlobalHook=function(d,c){_addHook("global",d,c)};b.addEditorHook=function(e,d){var c=b.activeEditor;if(c){_addHook("editor_"+c.index,e,d)}};return b})();sMathquill.config={menu_bars:{}};sMathquill.menuItemList={_line_break:{html:"<br/>"},_separator:{html:'<span class="s-mq-separator"></span>'}};(function(b){var a={main:{menu_items:["menu_operators,menu_relationships,menu_equations,menu_arrows,menu_misc,menu_greek"]},greek:{submenu:true,multiline:true,menu_items:["alpha,beta,gamma,delta,epsilon,zeta,eta,theta,iota,kappa,lambda,mu,nu,xi,omicron,pi,rho,sigma,tau,upsilon,phi,chi,psi,omega","digamma,varepsilon,varkappa,varphi,varpi,varrho,varsigma,vartheta","Gamma,Delta,Theta,Lambda,Xi,Pi,Sigma,Upsilon,Phi,Psi,Omega"]},operators:{submenu:true,multiline:true,menu_items:["equal,plus,minus,ast,cdot,times,div,pm,mp,therefore,because","bigcirc,diamond,amalg,odot,ominus,oplus,otimes,wr","union,intersect,uplus,sqcap,sqcup,wedge,vee,dagger,ddagger","lhd,rhd,bigtriangledown,bigtriangleup"]},relationships:{submenu:true,multiline:true,menu_items:["equiv,cong,neq,sim,simeq,approx,napprox,doteq,models","leq,prec,preceq,lt,ll,subset,subseteq,nsubset,nsubseteq,sqsubset,sqsubseteq,dashv,in,notin","geq,succ,succeq,gt,gg,supset,supseteq,nsupset,nsupseteq,sqsupset,sqsupseteq,vdash,ni,notni","mid,parallel,nparallel,perp,bowtie,smile,frown,propto,exists,nexists,varnothing"]},equations:{submenu:true,multiline:true,menu_items:["frac,fprime,sqrt,nthroot,supscript,subscript,curly_braces,angle_brackets,lfloor,rfloor,lceil,rceil,slash","sum,prod,coprod,limit,int,oint,binomial,vector,prime"]},arrows:{submenu:true,multiline:true,menu_items:["leftarrow,Leftarrow,rightarrow,Rightarrow,leftrightarrow,Leftrightarrow","longleftarrow,Longleftarrow,longrightarrow,Longrightarrow,longleftrightarrow,Longleftrightarrow","rightleftarrows,uparrow,Uparrow,downarrow,Downarrow,updownarrow,Updownarrow","mapsto,hookleftarrow,leftharpoonup,leftharpoondown,hookrightarrow,rightharpoonup,rightharpoondown","nearrow,searrow,swarrow,nwarrow"]},misc:{submenu:true,multiline:true,menu_items:["infty,nabla,partial,clubsuit,diamondsuit,heartsuit,spadesuit,cdots,vdots,ldots,ddots,imaginary,real","forall,reals,complex,naturals,rationals,integers,ell,sharp,flat,natural,hbar,surd,wp","angle,measuredangle,overline,overrightarrow,overleftrightarrow,triangle,top,bot,caret,underscore,backslash,vert,AA","circ,bullet,setminus,neg,dots,aleph,deg"]}};
